...
|------|-------|-----------|-------|-------|
| Context-engineering comprehensive revision | adapt — implementation in progress | `docs/audits/2026-07-28-context-engineering-comprehensive-handoff.md`; Claude review: `docs/audits/2026-07-28-context-engineering-claude-review.md` | Codex implementation owner | Claude verdict **ADAPT** on 2026-07-28; six blocking corrections are incorporated into the implementation lane. Applies when touching task context, compaction/handoffs, subagent briefs, external implementation precedent, or rules-file budgets. |
