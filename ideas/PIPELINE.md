...
|------|-------|-----------|-------|-------|
| Context-engineering comprehensive revision | pending cross-provider review | `docs/audits/2026-07-28-context-engineering-comprehensive-handoff.md`; next artifact is a Claude `approve/adapt/defer/reject` review | Claude reviewer, then implementation owner | Applies when touching task context, compaction/handoffs, subagent briefs, external implementation precedent, or rules-file budgets. Build is blocked on the independent review. |
