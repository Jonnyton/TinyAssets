...
|------|-------|-----------|-------|-------|
| Main-account cloud OpenSpec drain | promoted — approved for OpenSpec | `docs/design-notes/2026-07-29-main-account-cloud-spec-drain.md`; `openspec/changes/activate-main-universe-spec-drain/` | OpenSpec lane | Host approved 2026-07-29: one cloud-owned loop, tray stopped at cutover, and phone-chatbot management/repair/evolution with the computer fully off; BYOC precedes market compute. |
