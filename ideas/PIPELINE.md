...
|------|-------|-----------|-------|-------|
| Context-engineering comprehensive revision | promoted — implementation complete on branch | `.agents/skills/context-engineering/SKILL.md`; `.agents/skills/implementation-precedent-scout/SKILL.md`; evidence in `docs/audits/2026-07-28-context-engineering-*.md` | merge/fold-back owner | Claude research verdict **ADAPT** and implementation review completed; skill implementation is commit `ca852f55`. Applies when touching task context, compaction/handoffs, subagent briefs, external implementation precedent, or rules-file budgets. |
