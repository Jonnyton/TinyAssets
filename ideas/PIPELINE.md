...
|------|-------|-----------|-------|-------|
| Open compute/model/fabrication market — live inference and training prices, user-designed models, permissionless hosting, hardware/device designs, and maker capacity | promoted | `docs/audits/2026-07-21-compute-llm-market-architecture-implications.md`; follow-on OpenSpec exploration requires host approval | codex-gpt5-desktop | Claude opposite-provider verdict ADAPT folded in 2026-07-21. Direction: shared commercial envelope over existing request/bid/claim/settlement and unchanged B2 execution; typed lane-specific acceptance; external providers price-only until BYOK/resale custody is separately ratified; no AMM or universal execution protocol. |
| Zapier-equivalent automation — users can compose anything available in Zapier while TinyAssets stays minimal-primitives, commons-first, provider-neutral, and hostless-capable | promoted | `docs/audits/2026-07-21-zapier-automation-platform-implications.md`; follow-on OpenSpec exploration requires host approval | codex-gpt5-desktop | Claude opposite-provider verdict ADAPT folded in 2026-07-21. Graph core is already stronger; implement/conform the binding `boundary-layer` rather than clone products. Scheduler/ingress/connection/effect/retry/typed-artifact/public-control gaps plus exactly-once truth conflict block build. |
| User growth + concurrent-user scalability — prove the architecture under many simultaneous chatbot users, events, runs, daemons, and market operations | promoted | `docs/audits/2026-07-21-user-growth-concurrency-scalability-implications.md`; follow-on OpenSpec exploration requires host approval | codex-gpt5-desktop | Claude opposite-provider verdict ADAPT folded in 2026-07-21. Current deploy is single-origin/file+SQLite authority and Track J has no load harness. Complete compute+model authority bundles, a live BYOC route, strict allowlists/receipts, and provider-routing alignment are required before scale proof. |
| Organizational universes / company brains — a shareable, versioned universe design that organizations govern and run from Slack, Teams, or existing business systems | promoted | `docs/audits/2026-07-21-organizational-universe-company-brain-implications.md`; future OpenSpec requires host decision | codex-gpt5-desktop | Claude ADAPT folded 2026-07-22. Slack/Teams are interaction surfaces, not brain/authority. P0: public-default visibility, global daemon reads, R2-1a/b, consent-path live bug, and canonical PLAN commons-first vs host-ratified permissioned-private conflict. |
| Regulated-industry deployment profiles — HIPAA and other sector/jurisdiction standards expressed as composable policy/control/evidence packs | promoted | `docs/audits/2026-07-21-regulated-industry-compliance-architecture-implications.md`; future OpenSpec requires host decision | codex-gpt5-desktop | Claude ADAPT folded 2026-07-22 and independently rechecked core legal claims. Use generic enforcement + signed policy/evidence/conformance packs; separate control availability/config/evidence from customer determination and external certification/authorization. Private-data model must be reconciled first. |
