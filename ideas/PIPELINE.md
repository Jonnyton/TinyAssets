...
|------|-------|-----------|-------|-------|
| Main-account cloud OpenSpec drain | promoted — Ringer-informed implementation active | `docs/design-notes/2026-07-29-main-account-cloud-spec-drain.md`; `openspec/changes/activate-main-universe-spec-drain/`; `docs/audits/2026-07-30-ringer-production-orchestration-implications.md` | Codex research → Claude review → OpenSpec/runtime lane | Host approved 2026-07-29: one cloud-owned loop, tray stopped at cutover, phone-chatbot management/repair/evolution with the computer fully off, BYOC before market compute. Host reprioritized 2026-07-30 to implement lessons from Ringer as a generic user-owned GitHub→spec production system; Jonathan's drain is the first conformance proof, never privileged product logic. |
