...
|------|-------|-----------|-------|-------|
| Tiny/TinyAssets naming and Workflow retirement | promoted | `docs/design-notes/2026-06-27-tinyassets-rename-migration.md`; `docs/exec-plans/active/2026-06-27-tinyassets-rename-migration.md`; `PLAN.md` Canonical Naming Boundary | codex-gpt5-desktop | Promoted 2026-06-27 from host directive. Boundary: Tiny = personified intelligence; TinyAssets = platform/site/repo/distribution brand; Workflow/workflow = migration-only compatibility name to retire after staged replacements and verification. |
