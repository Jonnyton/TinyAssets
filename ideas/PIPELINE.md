...
|------|-------|-----------|-------|-------|
| Context-engineering comprehensive revision | near-term future review for implementation | `docs/audits/2026-07-28-context-engineering-comprehensive-handoff.md`; next artifact is a Claude `approve/adapt/defer/reject` review | Claude reviewer, then implementation owner | Host clarified 2026-07-28: keep this out of the current task and schedule it for near-term implementation review. Applies when touching task context, compaction/handoffs, subagent briefs, external implementation precedent, or rules-file budgets. Build remains blocked on the independent review. |
