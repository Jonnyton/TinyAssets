...
|------|-------|-----------|-------|-------|
| Main-account cloud OpenSpec drain | promoted — design review | `docs/design-notes/2026-07-29-main-account-cloud-spec-drain.md`; then `openspec/changes/activate-main-universe-spec-drain/` after approval | host review | Host clarified 2026-07-29 that this is a first-party dogfood workload for the user-buildable loop: it must run in Jonathan's cloud universe with user-owned provider authority, not depend on his PC, and precede any market-compute path. |
