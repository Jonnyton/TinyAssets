...
- [x] 4b.2 Move loop declaration off the universe scalar: an owner may declare and change automation loops AFTER birth through the advertised handles. Any universe-level default becomes a mutable set, never a write-once value. Add no advertised handle.
