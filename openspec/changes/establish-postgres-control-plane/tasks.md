...
- [ ] 1.7 Re-run OpenSpec/STATUS/idea/provider-context collision checks and update downstream dependencies before claiming any runtime, deployment, database, or production-inventory file. Treat PR #1792 as open and unsatisfied until its implementation/schema actually lands; treat #1800 as the merged handoff owner without promoting its prototype migration.
