...
- [ ] 1.5 OpenSpec delta authorizing the flag-gated exception (ADAPT #4; this change — checked only once strict validation passes and the delta is synced on land)
