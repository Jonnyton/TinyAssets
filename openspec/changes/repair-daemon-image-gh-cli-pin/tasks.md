...
- [ ] 0.1 Independently review the current-main proposal, design, capability delta, and bounded task plan across correctness, security, release safety, and scope; fold every blocking finding before implementation.

## 1. Test-first repair

- [ ] 1.1 Record the exact red image-build evidence and independently verify the replacement release and package version against GitHub's official release API and configured signed apt package index.
