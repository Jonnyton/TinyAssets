...
- Preserve the provider-neutral WebRTC bridge, canonical `converse` writer, disclosure, teardown, and dark-launch gates. Never substitute a platform/shared credential, platform-paid usage, anonymous access, or a different provider.
...
- Focused storage, authority, route, browser-state, and regression tests are required. Voice remains disabled in production until independent review, deployment, and user-authorized live acceptance.
