...
- [x] Research and refine typed experience primitives, lossless authoring, upstream overlays, device races, voice/routing semantics, E-C1–E-C16 traces, editable intent, confined messaging, accessible action status and harness parity.
