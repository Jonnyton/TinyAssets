...
- [ ] 5.7 Gate epoch-2 enqueue until all pre-authority rows are linked, held, or boundedly drained: admit only already-claimed public rows, pin their existing public version, forbid descendants/provider/private/ambient authority, close them before one activation deadline, and hold deadline-expired rows; require zero unclassified work.
