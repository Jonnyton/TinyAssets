...
- [x] 1.3 Define typed `BackgroundBranchBinding`, `BackgroundBranchAttempt`, source-kind, target-mode, lifecycle, hold-reason, and provenance contracts with strict validation and lossless round trips. Completed 2026-07-30 in `tinyassets/background_branch_authority.py`: 77 focused tests prove lossless typed records, closed binding roots and resume/child operations, canonical non-bearer references and SHA-256 digests, canonical ordered UTC timestamps, immutable nested inputs, lifecycle/audience invariants, and root/child lineage.
