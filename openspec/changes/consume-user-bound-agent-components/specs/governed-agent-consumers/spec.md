...
- **AND** trusted recovery remains reachable
...
adapter contract. The first proposed adapter SHALL invoke an immutable published
...
- **THEN** activation or execution refuses with the concrete prerequisite
...
turn, restoring revoked grants or undoing completed effects.
