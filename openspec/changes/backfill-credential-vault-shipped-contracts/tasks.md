## 1. Preserve Reviewed Evidence

- [x] 1.1 Specify exact alias, first-record, base64, and replacement behavior
- [x] 1.2 Run focused credential evidence and independent requirement-to-source review

## 2. Verify The Canonical Owner Premise
