...
- [ ] 4.2 Add a failing regression test for multiple admissions of one target in the same run.
- [ ] 4.3 Derive collision-safe admission branches and worktrees from the persisted attempt number.
