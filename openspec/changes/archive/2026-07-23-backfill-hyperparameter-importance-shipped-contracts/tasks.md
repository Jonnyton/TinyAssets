...
- [x] 1.1 Adjudicate canonical ownership against the future science-domain pre-spec
- [x] 1.2 Map public exports, evaluator source, packaged mirror, and focused tests
- [x] 1.3 Preserve dependency, conversion, schema, ranking, truncation, and output limitations
