...
- [x] 7.5 Follow-ups filed, not widened here: Claude's tool-wait gap was later resolved by PR3905 (see `docs/reviews/2026-09-21-provider-tool-wait-deployment.md`); a user **Stop** for a running turn remains tracked in `docs/concerns/2026-08-29-no-user-stop-for-a-running-turn.md`, cap-as-user-budget in `ideas/INBOX.md`.
