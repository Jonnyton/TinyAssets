...
ChatGPT acceptance. Its own connector-continuity delta gates runtime activation
of generic user-owned GitHub-to-spec automation without replaying obsolete
amendments to that separately evolving change. No new MCP handle, auth bypass,
maintainer credential path, or desktop-only recovery mechanism is introduced.
