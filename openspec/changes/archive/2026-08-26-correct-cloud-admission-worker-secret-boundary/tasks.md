...
- 2026-08-03, after exact-head `e45c80e1` review closure: Windows passed the complete six-file suite at 263 tests with 76 POSIX skips; Ubuntu WSL passed 107 installer/log/fleet tests with 43 unavailable-Compose skips. Invoked regressions reject a different immutable target digest before rotation and reject current-worker or earlier-worker replacement while quiescence reads state by pinned ID and completes its final name-to-ID pass.
- 2026-08-03, after rebase onto `38074e40` (#2197/#2199): Windows passed 267 security/deploy/thread-invariant tests with 76 POSIX skips; Ubuntu WSL repeated 107 installer/log/fleet passes with 43 unavailable-Compose skips. The shared quarantine cleanup and process-wide patch invariant are now in the exact base.
- 2026-08-03, after clean rebase onto `6a9e8c72` (#2198/#2200): Windows repeated 267 security/deploy/thread-invariant passes with 76 POSIX skips; Ubuntu WSL repeated 107 installer/log/fleet passes with 43 unavailable-Compose skips. The current-main OAuth canary changes do not overlap this correction's write set.
