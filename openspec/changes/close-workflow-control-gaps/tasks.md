...
- [x] 1.2 Pin baseline and add failing regressions through actual dispatch/read/edit/control paths for the five reported gaps.

## 2. Implement

- [x] 2.1 Make edit guidance and validated owned-node operations agree while preserving existing field/authority validation.
...
- [x] 3.2 Merge through normal CI guards, deploy and pass authenticated canary plus deployed-SHA containment.
