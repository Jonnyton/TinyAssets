...
- [ ] 3.1 Sync only the reviewed ADDED requirements into `openspec/specs/graph-execution-substrate/spec.md` and prove the pre-sync canonical file remains an exact prefix.
