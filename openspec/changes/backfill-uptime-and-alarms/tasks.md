...
- [ ] 2.4 Run focused canary, paging, watchdog, triage, deploy, backup, and DR regression tests; do not run `tests/test_uptime_canary_layer2.py` through Codex on Windows.
- [ ] 2.5 Sync the new capability into `openspec/specs/uptime-and-alarms/spec.md` and verify strict validation of all specs.
- [ ] 2.6 Archive the completed change after proving sync idempotence.
