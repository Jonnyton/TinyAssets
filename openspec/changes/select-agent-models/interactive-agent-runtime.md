...
failure prevents launch and releases the unspent reservation. Store no live
...
launch allowance once, before its first launch. Derive a finite ceiling from the
distinct accepted provider-work bindings' existing max_invocations values,
