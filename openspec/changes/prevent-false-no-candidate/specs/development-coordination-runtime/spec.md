...
canonical claim checker reports zero claimable rows and zero policy-qualified
stale-claim candidates. Every drain-worker brief MUST require the worker to
resume its own claim, select claimable finish-first work, reap policy-qualified
stale claims, freshness-check blocker labels, and consider safe cross-cutting
promotion in that order before reporting no candidate. Live claims, host-owned
