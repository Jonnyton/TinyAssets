## 1. Durable Design Truth

- [x] 1.1 Fold the approved definition/binding/runtime model and power-user customization principle into `PLAN.md` and the idea pipeline.
