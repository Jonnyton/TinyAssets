...
- **[Mutex owner crashes]** → both waiters catch abandoned ownership, mark the lock acquired, continue under exclusive ownership, and release it in `finally`.
