...
- [ ] 2.1c Classify the exact candidate's bounded Docker start error without
  publishing raw error text, make sanitization/deletion real publication gates,
  and execute the capture shell across success and injected failure paths.
