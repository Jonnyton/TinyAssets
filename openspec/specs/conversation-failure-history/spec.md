# Conversation failure history

## Purpose

Preserve admitted failed chat turns as safe, owner-scoped conversation evidence,
without inventing successful replies or automatically replaying work.
