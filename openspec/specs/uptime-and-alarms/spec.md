...
- **WHEN** that assignment is valid
- **THEN** the drill supplies only that validated reference ephemerally to Compose and does not copy or persist the primary environment
- **AND** terminal evidence distinguishes it from the Debian provider image
