...
#### Scenario: Consecutive red outputs can remain below threshold
- **WHEN** red probe steps are tolerated and their completed workflows conclude success
- **THEN** the next sink does not recognize the prior red as a failed workflow and no new `dns-red` issue is guaranteed
...
#### Scenario: Consecutive red outputs can remain below threshold
- **WHEN** red probe steps are tolerated and their completed workflows conclude success
- **THEN** the next sink does not recognize the prior red as a failed workflow and no new `llm-binding-red` issue is guaranteed
