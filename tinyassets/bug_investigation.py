...
def _enqueue_investigation_task(
    ...
    # after this check or while the task sits queued. The retired JSON claim path
    # is fail-closed, so it cannot run the task; S4/S10 must repeat this check in
    # the sole SQLite claim transaction. Fail here with a structured
