...
user-sim discipline), branch_run (compose with tinyassets.api.runs),
    ...
    **_extra: Any,
    ...
    Args:
        ...
        action_handler: callable matching the MCP-action contract
            ...
            handlers, this is the function from `tinyassets/api/market.py`
...
def register() -> None:
    ...
    """
    from tinyassets.evaluation.scenario_runner import register_dispatcher
