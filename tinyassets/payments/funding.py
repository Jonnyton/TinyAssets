...
MicroTokens. Schema lives in tinyassets.payments.schema (staker_escrow_budget).

Pairs with tinyassets.payments.settlement_ledger (the settlement/treasury side):
...
from tinyassets.payments.schema import StakerEscrowBudget, migrate_settlement_schema
