...
Its verdict is **ADAPT**, not approval or implementation authority. The adjacent
report folded the provider-route correction, but every capacity, deployment,
code, and spec prescription requires a fresh current-main check.
