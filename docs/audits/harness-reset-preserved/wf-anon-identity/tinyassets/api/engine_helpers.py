...
def _current_actor() -> str:
    ...
    entry. An unresolved OAuth-backed request fails closed as anonymous;
    explicit dev/no-auth paths keep the legacy env-var fallback.
    """
    try:
        ...
        return "anonymous"
    from tinyassets.api.permissions import is_unresolved_external_request

    if is_unresolved_external_request():
        return "anonymous"
