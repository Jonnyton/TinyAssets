...
def test_get_status_account_user_uses_authenticated_subject(
    ...
    payload = json.loads(get_status(universe_id="status-uni"))
...
async def test_auth_context_middleware_sets_actor_for_request(
    ...
    # Once the OAuth request context exits, the unresolved external caller
    # fails closed instead of regaining the ambient host identity.
