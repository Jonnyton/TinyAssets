...
**Base:** `origin/main` `c201beb97f080c8c4655882ce83ada0d814668ae`
...
- #1775 is merged and owns the shared load-evidence protocol. Its implementation
  ...
  land.
- #1800 is merged and owns real-world handoff lifecycle, receipts, and outcome
  registry extensions. Its prototype migration `014_real_world_handoffs.sql`
  remains fixture-only provenance. This generic substrate cannot promote that
  SQL, mint handoff authority from a row, or move handoff into PostgreSQL
...
6. preserve #1800 handoff authority while keeping its migration fixture-only;
   and
