...
**Host invariant (2026-07-21):** TinyAssets does not provide execution compute
or model quota. Every user run uses requester-authorized BYOC/BYOM or an
explicitly accepted market offer. Founder/maintainer Claude and OpenAI
subscriptions, rate limits, credentials, hardware, and billing are owner-scoped
and MUST NOT be used by other users or as a fallback.
