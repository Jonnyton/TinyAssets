...
**Likely touch points:** `tinyassets/dispatcher.py`, `tinyassets/branch_tasks.py`, `tinyassets/producers/node_bid.py`, host-pool bid polling, decision logs surfaced in tray/chat, and runtime prompt composition for soul-aware decisions.
