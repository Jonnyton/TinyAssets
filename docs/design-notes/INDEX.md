...
- [RetroLab Recipe Linter v1](2026-05-08-retrolab-recipe-linter-v1.md) - **status: research.** Repository-side preservation of wiki proposal `pages/plans/retrolab-recipe-linter-v1.md` / Issue #350. Captures v1 gates for lawful sources, SHA-256 completeness, proof beyond title screens, and reproducible manual steps; not yet canonical `PLAN.md` truth.
