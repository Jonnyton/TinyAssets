...
- [RetroLab Runner MVP v0.1](2026-05-05-retrolab-runner-mvp-v0-1.md) - **status: research.** Repository-side preservation of wiki proposal `pages/plans/retrolab-runner-mvp-v0-1.md` / Issue #351. Captures the proposed signed Windows runner, closed job allowlist, BASS/ScummVM acceptance proof shape, security gates, and missing nested-filing update primitive; not yet canonical `PLAN.md` truth.
