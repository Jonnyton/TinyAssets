...
|---|---:|---|
| CANONICAL | 14 | Surviving shipped substance has a canonical OpenSpec owner. |
| ACTIVE | 0 | No legacy file itself is the owner of an active OpenSpec target. |
| CLAIMED | 23 | Residue is assigned to a live STATUS backfill, host-decision, or target lane. |
| HISTORY | 15 | Superseded, research, fixture, exemplar, fragment, or parked input. |
