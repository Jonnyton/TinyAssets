...
| **P2** | [Nothing seeds the learned cursor](2026-09-26-learned-cursor-prerequisites-for-a-reader.md) — inert today: `start_learned_cursor` has no caller, so every existing conversation reads 0 and a stage-2 drain would re-extract its whole history on the founder's own credential; the sibling soft-zero defect is fixed in #4004 | 2026-09-26 |
