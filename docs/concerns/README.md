...
| **P2** | [WorkOS production needs a public client](2026-08-29-workos-production-needs-a-public-client.md) — the switch was attempted and rolled back: the app's client id is a native/public client that is not listed under Applications and has no production equivalent yet | 2026-08-29 |
