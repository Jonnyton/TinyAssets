...
|---|---|---|
| **P0** | [iOS App Store upload requires Xcode 26](2026-09-03-ios-app-store-upload-requires-xcode-26.md) — signing and export pass, but App Store Connect rejects the `macos-15` default Xcode 16.4/iOS 18.5 SDK; the Xcode 26.3 fix is locally green and blocked on required Claude review because that subscription hit its monthly spend limit | 2026-09-03 |
