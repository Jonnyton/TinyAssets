...
| **P1** | [Provider admission sized against host, not cgroup](2026-08-28-provider-limit-sized-against-host-not-cgroup.md) — 25 survives only the assumed 3x floor under the committed 4 GiB cap; a 2 GiB cap mutant still passes all admission tests | 2026-08-28 |
