...
|---|---|---|
| **P2** | [Run submission accepts missing required branch inputs](2026-09-03-run-submission-accepts-missing-required-inputs.md) — the live served agent admitted two prompt smoke runs with empty inputs and only named the required keys after execution had already failed; submission needs a preflight refusal with exact missing-input guidance | 2026-09-03 |
