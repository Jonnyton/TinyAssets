...
| **P1** | [Deploy drops the subscription-auth sync](2026-08-27-deploy-drops-subscription-auth-sync.md) — no workflow delivers `TINYASSETS_CODEX_AUTH_JSON_B64` or `TINYASSETS_CLAUDE_CREDENTIALS_JSON_B64` any more, so rotation is inert and a rebuilt droplet comes up unauthenticated | 2026-08-27 |
