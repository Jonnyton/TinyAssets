...
| **P1** | [Pending-request secret readable storage](2026-08-27-pending-request-secret-readable-storage.md) — undeclared answer keys and feedback can persist a credential verbatim | 2026-08-27 |
...
| **P2** | [Pending-request duplicate-field DOM secret](2026-08-27-pending-request-duplicate-field-dom-secret.md) — duplicate agent-chosen field names leave the second secret control uncleared | 2026-08-27 |
