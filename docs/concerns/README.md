...
| **P1** | [Scheduled uptime coverage remains incomplete](2026-09-08-scheduled-uptime-probes-remain-red.md) — deployed classifier honestly reports unavailable execution-quality and rendered observations; natural post-merge cron acceptance and independent coverage remain open | 2026-09-08 |
