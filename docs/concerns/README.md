...
| **P2** | [Voice conversation cuts off speech and lacks visible interruption/voice choice](2026-09-05-voice-conversation-turn-taking-and-choice.md) — founder reports premature sentence endings, no listening during replies, and no apparent voice selector; both-way audio works | 2026-09-05 |
