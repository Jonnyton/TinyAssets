...
| **P2** | [The live Play listing screenshot shows internal repo and architecture detail](2026-09-03-play-listing-screenshot-shows-internal-repo-detail.md) — the entered Play Console screenshot is a debugging capture showing the private repo path, seventeen commit SHAs, internal node/scope vocabulary, and a candid internal blocker, plus the app's blocked "WAITING ON YOU" state; needs a founder decision on the replacement | 2026-09-03 |
