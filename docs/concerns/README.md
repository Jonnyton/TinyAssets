...
| **P2** | [The outbound broker child failed to start, cause never found](2026-08-27-outbound-proxy-start-failure.md) — was P0; egress verified working 2026-08-31 (the universe opened #2691 through it). The intermittent was never diagnosed, and `source_code` nodes are still unrunnable: `mark_approved` has zero non-test callers | 2026-08-27 |
