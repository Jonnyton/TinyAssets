...
| **P0** | [The outbound broker child fails to start, and nothing can say why](2026-08-27-outbound-proxy-start-failure.md) — every `authenticated_external_call` in production fails | 2026-08-27 |
