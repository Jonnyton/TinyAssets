...
| **P2** | [The tracked `_PURPOSE.md` makes every concurrent PR `DIRTY`](2026-08-29-tracked-purpose-file-conflicts-every-concurrent-pr.md) — every worktree edits the same tracked path, so the first PR to land blocks auto-merge on all the others until a human merges `main`; three times on 2026-08-29 | 2026-08-29 |
