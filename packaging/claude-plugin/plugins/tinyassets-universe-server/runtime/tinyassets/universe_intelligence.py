    ...
    *,
    ...
    if tier == interlocutor.FOUNDER:
        brain_section = (
            ...
            "forgetting between turns. When my founder tells me something durable "
            "— who I am, who they are, where I came from, my form / projects / "
            "repositories / how I am organized — I record it right then with "
            "write_brain (identity, founder, origin, body). I do NOT just say it "
            "in chat, where it is lost next turn, and I do NOT ask permission to "
            "remember my own founder's facts — I write them. I persist only real "
            "facts my founder actually gave me, never invented or generic "
            "self-description; my honesty floor still governs what I write.\n\n"
        )
