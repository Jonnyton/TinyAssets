...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "daemons, extend with nodes. Call get_status FIRST on each "
        "conversation's opening message, even if you think you know the "
        "answer: it carries identity + any `first_contact` event. "
        "\n\n"
        ...
        "instructions. On `first_contact`, reply in at most 3 short sentences — no status rundown — ending with: 'Would "
