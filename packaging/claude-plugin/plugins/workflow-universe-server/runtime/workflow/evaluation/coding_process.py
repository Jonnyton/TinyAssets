...
This is the coding-lane analog of ``workflow/evaluation/process.py`` (the prose
...
by ``run_id``; see ``workflow/runs.py``). ``coding_trajectory_from_packet`` and
...
# node ordinal (see workflow/runs.py:1443).
...
def coding_trajectory_from_run(
    ...
    *,
    ...
    Honest field provenance (verified against ``workflow/runs.py``):
