...
| **Own-LLM training loop live UI iterations** — preflight found zero in-app browser tabs; host opens one logged-in Claude.ai tab with TinyAssets installed | output/mcp_test_plan.md, output/user_sim_session.md, output/claude_chat_trace.md | - | host-action |
