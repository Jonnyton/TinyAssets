...
| **Prepare PLAN conflict decision packet** — canonical store, private/org data, tool shape, and privacy/compliance ownership; no PLAN/OpenSpec edits before approval | docs/audits/2026-07-23-full-platform-plan-decision-packet.md | host design approval; Claude opposite-provider review before PLAN/OpenSpec/build/push | claimed:codex-gpt56-spec-4 ACTIVE 2026-07-23 |
