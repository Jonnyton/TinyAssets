...
| **Backfill shipped per-job sandbox runner seam** — canonicalize only landed `runner/v1`; no backend/integration claim | openspec/changes/backfill-per-job-sandbox-runner-seam/; openspec/specs/distributed-execution/spec.md; docs/audits/2026-07-22-openspec-full-coverage-audit.md | active distributed-execution/PR #1475 read-only; #1485 source/tests | claimed:codex-gpt56-spec ACTIVE 2026-07-22 |
