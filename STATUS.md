...
| **Promote hyperparameter-importance evaluator into OpenSpec** | openspec/changes/hyperparameter-importance-evaluator/ | canonical `evaluation-runtime-and-scenarios` owner; future science-domain pre-spec is target-only | pending |
