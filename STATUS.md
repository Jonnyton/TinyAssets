...
| **Review hyperparameter science target design** — current methods, domain owner, MVP, exclusions, and pickup packet; no OpenSpec/build before approval | docs/audits/2026-07-23-hyperparameter-science-design-review.md | user design approval; Claude opposite-provider review before build/push | claimed:codex-gpt56-spec-3 ACTIVE 2026-07-22 |
