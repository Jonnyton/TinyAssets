...
|------|-------|---------|--------|
| **Converge fresh-host uptime installers** — install both watchdogs, backup, prune, and disk-watch with current scripts; always enable timers | deploy/hetzner-bootstrap.sh; deploy/install-host-uptime-services.sh; .github/workflows/install-host-services.yml; tests/test_host_uptime_installers.py; deploy/DEPLOY.md; openspec/changes/converge-host-uptime-installers/; openspec/specs/uptime-and-alarms/spec.md | #1652; fresh 2026-07-23 installer audit | claimed:codex-gpt56-sol ACTIVE 2026-07-23 |
