...
| **Disposition all 52 legacy specs** — canonical, active, history, or claimed target | docs/audits/2026-07-22-legacy-spec-disposition.md; docs/specs/INDEX.md; openspec/changes/brain-okf-canonical-store/proposal.md; openspec/changes/brain-okf-canonical-store/design.md; openspec/changes/brain-okf-canonical-store/tasks.md | #1616, #1619 | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
| **Promote runtime-fiction memory graph into OpenSpec** | openspec/changes/runtime-fiction-memory-graph/ | legacy disposition; brain-okf-canonical-store | pending |
| **Promote hyperparameter-importance evaluator into OpenSpec** | openspec/changes/hyperparameter-importance-evaluator/ | legacy disposition; science-domain lane | pending |
