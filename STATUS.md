...
| **Backfill uptime + alarms as-built OpenSpec** — specify host-independent probes/page/triage, host watchdogs, deploy rollback receipt, backup + manual DR; repair layer-2 Windows hangs | openspec/changes/backfill-uptime-and-alarms/, openspec/specs/uptime-and-alarms/spec.md, scripts/browser_lock.py, tests/test_uptime_canary_layer2.py | exclude release-reconcile-event-trigger ownership; read-only live-MCP, daemon-runtime, community-patch specs | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
