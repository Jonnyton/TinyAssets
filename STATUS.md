...
| **R2-1a set_engine/credential ceiling** — code green in draft PR #1606; building offline migration/fence; DO NOT MERGE before reviewed live `/data` migration | tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, tests/test_{s2_engine_assignment,s6_s8_engine_sources,credential_fail_closed,provider_allowlist,per_universe_engine_resolution,migrate_engine_assignments,deploy_prod_workflow}.py, scripts/migrate_engine_assignments.py, Dockerfile, .github/workflows/deploy-prod.yml, deploy/DEPLOY.md, packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, openspec/changes/constrain-founder-provider-routing/, openspec/changes/universe-creation/{design.md,tasks.md}, STATUS.md, REFLECTION.md, .agents/worktrees.md | canonical spec sync waits on active provider/credential Batch B; request authority/run_graph stays #1582; live quiesced run required; R2-1b waits | in-flight draft PR #1606 DO NOT MERGE ACTIVE 2026-07-22 |
