...
| **Promote runtime-fiction memory graph into OpenSpec** — planning only; keep shipped ScenePacket under `domain-plugin-runtime` | openspec/changes/runtime-fiction-memory-graph/; docs/audits/2026-07-23-runtime-fiction-memory-graph-openspec-review.md; .agents/worktrees.md | brain-okf-canonical-store; Claude opposite-provider review before artifact push/build | claimed:codex-gpt56-spec-5 ACTIVE 2026-07-23 |
