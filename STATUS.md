...
| **Backfill remaining credential-vault shipped contracts** — current-main alias/first-record and fixed-temp truth; #1606 is an unlanded future draft, not a backfill gate | openspec/changes/backfill-credential-vault-shipped-contracts/; openspec/specs/credential-vault/spec.md; STATUS.md; LANE_REPORT.md | #1549 touches a separate clause in the same canonical spec; cross-family review before PR | claimed:codex-osx-vault-backfill ACTIVE 2026-07-24 |
