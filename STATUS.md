...
|------|-------|---------|--------|
| Paid-market core bundle landed (2026-07-08/09 sprint + 07-11 additions): 177 tests green, fast matcher, migrations 006–008, dead 002_rls atticed; branch `worktree-paid-market-core`, draft PR open | tinyassets/paid_market/, tests/test_paid_market_core.py, tests/test_match_scale.py, prototype/full-platform-v0/migrations/, docs/exec-plans/active/2026-07-0*, docs/SUCCESSION-2026-07-08.md + sprint docs | - | host-review |
