...
| **PLAN conflict decision packet** — final `ABA08D25`; 3 Codex reviews APPROVE; host approve/adapt/reject, then Claude review | docs/audits/2026-07-23-full-platform-plan-decision-packet.md | no PLAN/OpenSpec/build/push before host + Claude approval | host-decision |
