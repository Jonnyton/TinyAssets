...
|------|-------|---------|--------|
| TinyAssets rename migration — boundary plan + public front-door copy | PLAN.md, README.md, assets/brand/README.md, WebSite/site/{README.md,package.json,package-lock.json,src/{app.html,routes,lib/{components,content,graph,live,i18n/en.json}}}, WebSite/design-source/source_copy/en.json, docs/design-notes/2026-06-27-tinyassets-rename-migration.md, docs/exec-plans/active/2026-06-27-tinyassets-rename-migration.md, ideas/PIPELINE.md, ideas/INBOX.md | host directive 2026-06-27; branch `codex/tinyassets-rename-migration`; worktree `../wf-tinyassets-rename-migration`; claim_check clear for Phase 1 | claimed:codex-gpt5-desktop ACTIVE 2026-06-27 |
