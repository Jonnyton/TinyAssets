...
| **Epoch-2 mixed-row isolation proof** — forged, missing-receipt, and unsupported rows never execute or block valid v1/v2 selection | STATUS.md; tests/test_branch_tasks_v2.py; tests/test_dispatcher_queue.py; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md | #1702; OpenSpec task 6.6 | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
