...
| **Retire `/mcp-directory*`** — remove runtime/catalog/discovery/edge routing so only canonical `/mcp` survives; exact ordinary-404 proof | openspec/changes/reconcile-external-connector-manifests/tasks.md; tinyassets/{universe_server.py,directory_server.py,connector_catalog.py,auth/middleware.py,api/market.py}; deploy/cloudflare-worker/; .github/workflows/deploy-worker.yml; scripts/{mcp_public_canary.py,probe_retired_mcp_routes.py}; packaging/{registry/,claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/}; focused route/parity/admission/canary tests including tests/test_probe_retired_mcp_routes.py; docs/{ops/acceptance-probe-catalog.md,ops/mcp-host-proof-registry.md,ops/mcp-directory-*.md,ops/open-webui-no-login-pack.md,ops/librechat-no-login-pack.md,design-notes/2026-05-01-mcp-host-customer-matrix.md,exec-plans/active/2026-05-01-host-discoverability-and-onboarding-rollout.md} | PR #1688; preserve dated proofs; canonical hardening remains separately review-gated | claimed:codex-gpt56-mcp-retirement ACTIVE 2026-07-24 |
