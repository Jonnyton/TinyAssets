...
- [filed:2026-06-30] Slice-3 ACL residual F5: `engine_helpers._current_actor()` UNIVERSE_SERVER_USER fallback = run attribution only (not hardened authz) — defense-in-depth audit item (F1/F2/F3 landed `27008470`).
