...
| **Reconcile obsolete five-handle OpenSpec** — archive historical change without syncing; preserve manifest and legacy-removal residuals as successors | openspec/changes/collapse-live-mcp-surface-to-5-handles/, openspec/changes/archive/2026-07-22-collapse-live-mcp-surface-to-5-handles/, openspec/changes/reconcile-external-connector-manifests/, openspec/changes/retire-legacy-live-mcp-tools/, STATUS.md, .agents/worktrees.md | #1595 canonical seven-handle truth; runtime/packaging read-only | claimed:codex-gpt5-desktop-2 ACTIVE 2026-07-22 |
