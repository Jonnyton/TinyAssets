...
| **R2-1a set_engine/credential ceiling** — implementation + cancellation-safe offline fence independently approved in draft PR #1606; DO NOT MERGE before reviewed live `/data` cutover | tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, tests/test_{s2_engine_assignment,s6_s8_engine_sources,credential_fail_closed,provider_allowlist,per_universe_engine_resolution,migrate_engine_assignments,deploy_prod_workflow,p0_triage_workflow}.py, scripts/migrate_engine_assignments.py, Dockerfile, .github/workflows/{deploy-prod,p0-outage-triage,restart-daemon,install-host-services,codex-auth-keepalive,claude-auth-keepalive}.yml, deploy/DEPLOY.md, packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, openspec/changes/constrain-founder-provider-routing/, openspec/changes/universe-creation/{design.md,tasks.md}, STATUS.md, REFLECTION.md, .agents/worktrees.md | #1582 request authority; reviewed manifest + live quiesced run; R2-1b waits | host-action draft PR #1606 DO NOT MERGE |
