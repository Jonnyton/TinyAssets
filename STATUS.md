...
| **R2-4a wiki discovery scoping** — GREEN independently approved; default discovery excludes coordination; sync/archive + PR checks next | openspec/changes/scope-wiki-discovery/; openspec/changes/archive/2026-07-24-scope-wiki-discovery/; openspec/specs/wiki-commons/spec.md; tinyassets/api/wiki.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/api/wiki.py; tests/test_{api_wiki,wiki_tools}.py | #1550 source-only; preserve visibility filtering; universe-creation owns universe_server.py | claimed:codex-gpt56-wiki-scope ACTIVE 2026-07-25 |
