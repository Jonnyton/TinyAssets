...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — exact-merge backup run 30072561993 green; isolated archive restore healthy. Fix live GH retention view (31 prunable vs keep=30), then prove deploy preservation | .github/workflows/{deploy-prod,install-host-services}.yml; scripts/backup_ship_gh.py; tests/{test_backup_ship_gh,test_backup_restore_drill_invariants,test_deploy_prod_workflow,test_host_uptime_installers}.py; openspec/changes/preserve-production-backup-config/; openspec/specs/uptime-and-alarms/spec.md; docs/ops/backup-restore-runbook.md; docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | exact-SHA production retention/deploy evidence | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
