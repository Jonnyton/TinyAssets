...
| **Backfill 17 shipped contracts into canonical OpenSpec** — current behavior only | openspec/changes/backfill-shipped-behavior-coverage/; docs/audits/2026-07-22-shipped-behavior-backfill-map.md | full-coverage audit; credential/distributed/OKF/connector changes | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
