...
| **Public capacity envelope contract** — current-main planning refresh in draft PR #1695; dated baseline + reusable §14 harness | STATUS.md; .agents/worktrees.md; openspec/changes/establish-public-capacity-envelope/ | #1670 adapter consumer; exact pre-implementation `claim_check` for future Files; stage-typed owner plug-ins; fresh Claude review + accepted re-review | claimed:codex-gpt56-capacity ACTIVE 2026-07-24 |
