...
|------|-------|---------|--------|
| TinyAssets rename migration plan — codify Tiny persona / TinyAssets platform boundary; inventory `Workflow` surfaces; plan retirement gates | PLAN.md, docs/design-notes/2026-06-27-tinyassets-rename-migration.md, docs/exec-plans/active/2026-06-27-tinyassets-rename-migration.md, ideas/PIPELINE.md, ideas/INBOX.md | host directive 2026-06-27; branch `codex/tinyassets-rename-migration`; worktree `../wf-tinyassets-rename-migration` | claimed:codex-gpt5-desktop ACTIVE 2026-06-27 |
