...
| **Review credential-vault shipped-contract backfill** — builder synced current-main alias/first-record and fixed-temp truth on `codex/osx-credential-vault-backfill`; #1606 was not a gate | openspec/changes/backfill-credential-vault-shipped-contracts/; openspec/specs/credential-vault/spec.md; LANE_REPORT.md | cross-family review before archive/PR/land; #1549 touches a separate clause in the same spec | host-review |
