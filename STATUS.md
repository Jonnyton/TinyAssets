...
|------|-------|---------|--------|
| **Reconcile core runtime OpenSpec coverage (Batch B)** — soul dispatch, work-target review, protocols/reuse/gates, and generic-evaluator ownership | openspec/changes/reconcile-core-runtime-spec-coverage/; openspec/specs/daemon-runtime-and-dispatch/spec.md; openspec/specs/shared-goals-and-convergence/spec.md; openspec/specs/evaluation-outcomes-and-attribution/spec.md | read-only docs/audits/2026-07-22-openspec-full-coverage-audit.md and current code/tests; no active-delta path collision | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
