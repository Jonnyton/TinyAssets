...
| **Split connector-manifest product contracts** — #1597 correctly shares seven names but conflates remote WorkOS `/mcp` with local MCPB stdio/auth-config; keep directory remote-five separate | openspec/changes/reconcile-external-connector-manifests/, STATUS.md, .agents/worktrees.md | origin/main 1272a3d4; legacy retirement waits | claimed:codex-gpt5-desktop-2 ACTIVE 2026-07-22 |
