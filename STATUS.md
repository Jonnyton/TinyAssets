...
| **R2-1a set_engine/credential ceiling** — repairing cancellation-safe cutover + fail-closed `lsof` proof after final audit; draft PR #1606 remains DO NOT MERGE | tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, tests/test_{s2_engine_assignment,s6_s8_engine_sources,credential_fail_closed,provider_allowlist,per_universe_engine_resolution,migrate_engine_assignments,deploy_prod_workflow,p0_triage_workflow}.py, scripts/migrate_engine_assignments.py, Dockerfile, .github/workflows/{deploy-prod,p0-outage-triage,restart-daemon,install-host-services,codex-auth-keepalive,claude-auth-keepalive}.yml, deploy/DEPLOY.md, packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, openspec/changes/constrain-founder-provider-routing/, openspec/changes/universe-creation/{design.md,tasks.md}, STATUS.md, REFLECTION.md, .agents/worktrees.md | audit blockers: false fence on cancellation + ambiguous `lsof`; #1582; R2-1b waits | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
