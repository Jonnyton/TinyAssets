...
| **Public capacity envelope contract** — truthful current single-origin/no-executor baseline plus reusable §14 capacity/isolation harness; planning only | STATUS.md; .agents/worktrees.md; openspec/changes/establish-public-capacity-envelope/ | #1670 adapter consumer; test-identity-and-reset; domain-owned BYOC/market/load scenarios; fresh Claude review before implementation | claimed:codex-gpt56-capacity ACTIVE 2026-07-24 |
