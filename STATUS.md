...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — #1676 fixed bucket identity; run 30070438676 created scoped key, then immediate data-plane list got 403 and rollback succeeded. Add bounded propagation retry, then prove backup | .github/workflows/{deploy-prod,install-host-services}.yml; tests/{test_deploy_prod_workflow,test_host_uptime_installers}.py; openspec/changes/preserve-production-backup-config/; openspec/specs/uptime-and-alarms/spec.md; docs/ops/backup-restore-runbook.md; docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | exact-SHA production backup/restore evidence | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
