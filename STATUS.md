...
| **Universe-personification relay survivors** — #1515 retires the reversed change; successor deltas stay active/unbuilt until implementation + tests, then sync/archive | openspec/changes/reconcile-universe-personification-relay/ | universe-visibility, brain-okf-canonical-store, live-mcp-connector-surface | claimed:codex-gpt5-desktop ACTIVE 2026-07-22 |
| **Restore OpenSpec truth on main** — correct distributed-execution's branch-only checkmarks and graph merge-reducer law drift; spec-only, no runtime change | openspec/changes/distributed-execution/tasks.md, openspec/changes/archive/2026-07-22-reconcile-graph-merge-reducer-single-writer/, openspec/specs/graph-execution-substrate/spec.md | ce91c359; 6b28cf89 / PR #1480 | claimed:codex-gpt5-desktop ACTIVE 2026-07-22 |
