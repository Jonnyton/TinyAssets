...
| **Prove uptime alarm §14 concurrency after #1638/#1639** — queued triggers and red→unknown→red/green must preserve one incident with no duplicate page | openspec/changes/prove-uptime-alarm-concurrency/; tests/test_uptime_canary_concurrency.py; docs/audits/2026-07-23-uptime-alarm-concurrency-proof.md; openspec/specs/uptime-and-alarms/spec.md | - | pending |
