...
| **Backfill sandbox availability and fail-loud execution contracts** | openspec/changes/backfill-sandbox-availability-contracts/; openspec/specs/{provider-routing,graph-execution-substrate}/spec.md; docs/audits/2026-07-22-openspec-full-coverage-audit.md | PR #1629; distributed-execution + PR #1573 read-only; exclude PR #1626 status owner | claimed:codex-gpt56-spec-2 ACTIVE 2026-07-22 |
