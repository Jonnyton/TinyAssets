...
| **Restore distributed-execution ledger truth on main** — port only the distributed ledger reconciliation from 203c09c1/ce91c359; mark PR-only work unchecked and retain current blocker evidence | openspec/changes/distributed-execution/tasks.md | origin/claude/ledger-reconcile@ce91c359; no implementation files | claimed:codex-gpt5-desktop ACTIVE 2026-07-22 |
