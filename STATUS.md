...
| **Backfill 4 runtime/memory shipped contracts into canonical OpenSpec** — PR #1624; daemon identity, daemon runtime, graph execution, read-only OKF export | openspec/changes/archive/2026-07-23-backfill-runtime-memory-shipped-contracts/; openspec/specs/{daemon-identity-and-host-pool,daemon-runtime-and-dispatch,graph-execution-substrate,knowledge-retrieval-and-memory}/; docs/audits/{2026-07-22-openspec-full-coverage-audit.md,2026-07-22-legacy-spec-disposition.md}; docs/specs/INDEX.md | #1622; read-coordinate `distributed-execution`, `brain-okf-canonical-store` | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
