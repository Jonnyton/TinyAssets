...
|------|-------|---------|--------|
| **First-contact BYOC/market authority** — fold the reviewed current-main packet into exact owning specs before any execution work | docs/audits/2026-07-23-first-contact-authority-opposite-provider-review-packet.md; .agents/worktrees.md; STATUS.md | draft #1660; current `universe-creation`; #1617; R2-1a; `provider-attempt-receipts`; Claude review after 2026-07-24 evening PT reset; no runtime edits before accepted fold-in | pending |
