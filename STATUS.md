...
| **Codex review gate** — in-node paced enqueue verb #1214 (67797ba3, ships dark); brief + adversarial Qs at `docs/audits/2026-05-30-in-node-enqueue-codex-review.md`; §14 proof green; verdict→approve/adapt before `WORKFLOW_NODE_ENQUEUE_ENABLED` flips live | docs/audits/2026-05-30-in-node-enqueue-codex-review.md, workflow/graph_compiler.py, workflow/branch_tasks.py | review approve/adapt | dev-ready:codex |
