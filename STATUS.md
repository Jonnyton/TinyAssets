...
| **Bind authenticated host principal to account (spec only)** — stable identity; #1736 owns/adapts desktop protocol; host sessions stay insert-always | openspec/changes/bind-host-principal-to-account/**; docs/audits/2026-07-25-host-principal-binding-owner-map.md; .agents/worktrees.md | #1736 `OriginClient`; WorkOS identity; #1746 custody; Opus 5 review | claimed:codex-gpt56-host-principal ACTIVE 2026-07-25 |
...
| **Universe-personification relay survivors** — building 6.3/6.6/6.8/6.9-interlocutor (visibility machinery landed #1734 unblocked 6.6); 6.1/6.7 stay #1583-gated | openspec/changes/reconcile-universe-personification-relay/, tinyassets/persona.py, tinyassets/universe_intelligence.py, tinyassets/api/status.py, tests/ | #1583 host decision (6.1/6.7 only) | claimed:fable-fleet-opus5 ACTIVE 2026-07-25 |
