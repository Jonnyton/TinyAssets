...
|------|-------|---------|--------|
| **Audit full as-built OpenSpec coverage** — map every PLAN/Forever surface to canonical requirements; turn omissions into file-bounded reconciliation tasks | docs/audits/2026-07-22-openspec-full-coverage-audit.md, openspec/changes/complete-as-built-spec-coverage/ | read-only PLAN.md, AGENTS.md, openspec/specs/, current code; exclude active change write-sets | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
