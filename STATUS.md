...
| **Backfill shipped contracts Wave 1** — constraint evaluation, desktop host, coordination diagnostics, domain plugins; current behavior only | openspec/changes/backfill-shipped-behavior-coverage/; docs/audits/2026-07-22-shipped-behavior-backfill-map.md | #1616 (landed) | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
| **Backfill remaining 13 shipped contracts into canonical OpenSpec** — preserve active-change boundaries | openspec/changes/backfill-shipped-behavior-coverage-wave2/ | Wave 1; credential/distributed/OKF/connector/universe/effect changes | pending |
