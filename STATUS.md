...
|------|-------|---------|--------|
| Mobile app scaffold - native iPhone + Android clients open as one-screen WorkOS-bound universe chat surfaces per app-experience note + OpenSpec `universe-personification` | clients/ios, clients/android, scripts/launchers, docs/design-notes/2026-06-30-tinyassets-universe-app-experience.md, docs/reference/mobile-app-setup.md, openspec/changes/universe-personification/{proposal.md,design.md,tasks.md,specs/universe-personification/spec.md} | OpenSpec `universe-personification` task 2.10; real chat routing depends on tasks 2.4/2.5; WorkOS/AuthKit design; Android plugin source `SangkuOh/build-androidos-apps` v0.1.3 reviewed | dev-ready |
