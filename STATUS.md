...
- [filed:2026-07-02 verified:2026-07-02] Multi-tenant isolation PROVEN deterministically (`tests/test_multi_tenant_isolation.py`, 5 tests, Codex ADAPT folded — `docs/audits/2026-07-02-multi-tenant-isolation-proof-codex-review.md`): N concurrent founders → distinct universes, correct home/ACL binding, cross-founder write/private-read denial, no ContextVar bleed, cold-start-race safe. Residual = host-gated live deploy (merge to main + WorkOS live audience + missing-token 401 + canary/ui-test).
