...
|------|-------|---------|--------|
| **Repair wiki canary OAuth-challenge contract** — issue #1564 has false-red since 2026-07-22 because the probe expects retired tool JSON instead of canonical HTTP 401 + challenge | scripts/wiki_canary.py; tests/test_wiki_canary.py; .github/workflows/uptime-canary.yml; tests/test_uptime_canary_workflow.py; openspec/changes/fix-wiki-canary-oauth-challenge/; openspec/specs/uptime-and-alarms/spec.md | live-mcp-connector-surface canonical auth contract; PR #1638 | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
...
| **Prove uptime alarm §14 concurrency after #1638/#1639** — queued triggers and red→unknown→red/green must preserve one incident with no duplicate page | openspec/changes/prove-uptime-alarm-concurrency/; tests/test_uptime_canary_concurrency.py; docs/audits/2026-07-23-uptime-alarm-concurrency-proof.md; openspec/specs/uptime-and-alarms/spec.md | Repair wiki canary OAuth-challenge contract releases the moving uptime workflow/spec | pending |
