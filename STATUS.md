...
| **R2-1a provider authority** — independently approved planning at `codex/constrain-engine-providers`; PR blocked by GitHub Pull Requests outage; runtime gated | STATUS.md; .agents/worktrees.md; openspec/changes/constrain-set-engine-provider-authority/ | #1660 accepted verdict + `universe-creation` fold; #1617 disposition; #1606 split; #1484; #1621/#1623; auth overlay; subordinate propagation; operator-priority overlap | claimed:codex-gpt56-desktop ACTIVE 2026-07-24 |
