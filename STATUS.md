...
| **R2-1b provider-attempt receipts (spec only)** — result-local evidence for reply + learning calls; preserve `call_provider()->str`; no secret-bearing fields or invented durable/public sink | openspec/changes/provider-attempt-receipts/ | #1606 / R2-1a apply blocker; runtime files remain unclaimed | claimed:codex-provider-receipts ACTIVE 2026-07-23 |
