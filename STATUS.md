...
1. **Current uptime priority 2026-05-02 22:10Z; updated 2026-05-07:** Community patch loop ALIVE end-to-end, but Issue #270 reopened FEAT-006 propagation: provider_exhausted needs visible per-provider reasons at run surfaces. Prior bottleneck also includes loop-content (BUG-051) + auto-ship policy authoring (PR #198 spec). PR #198 + #206 are design-only, ready to land.
