...
- [filed:2026-07-13 verified:2026-07-15] Old `workflow-data` volume closure: audited, content archived (sha-verified local+offsite), volume DELETED, D1 ledger history MERGED into live ledger (1,358 entries, daemon-verified). Backup lane RESTORED (nightly 03:00 UTC, proven green). Open: D2 universe revival from archive (host-decision). Record: docs/audits/2026-07-15-workflow-data-volume-audit.md.
