...
| **Correct PR #1622 canonical authority** — kill-switch precedence, exhaustion retry scope, audit certainty | openspec/changes/archive/2026-07-23-correct-independent-backfill-authority/; openspec/specs/external-effect-adapters/spec.md; openspec/specs/provider-routing/spec.md; docs/audits/2026-07-22-openspec-full-coverage-audit.md; tinyassets/providers/call.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/providers/call.py | #1621 legacy correction; post-merge security ADAPT | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
