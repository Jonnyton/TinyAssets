...
| **Epoch-2 eligible worker wakeup (6.4)** — restart only for current-worker-compatible merged candidates; leave zero-capacity work inert | tinyassets/cloud_worker.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/cloud_worker.py; tests/test_cloud_worker.py; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md; STATUS.md | #1707 | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
