...
| **Operator-request v2 admission/storage foundation** — inventory and transactional epoch-2 aggregate; writer remains disabled | STATUS.md; docs/ops/operator-request-v2-inventory.md; tinyassets/storage/request_admissions.py; tinyassets/daemon_server.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{daemon_server.py,storage/request_admissions.py}; tests/{test_request_admission_store.py,test_dispatcher_queue.py,test_submit_request_wiring.py,test_patch_request_incentives.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md | #1628; later auth/public/dispatcher/worker phases remain separate | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
