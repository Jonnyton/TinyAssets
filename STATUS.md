...
| **Retire MCP provider-secret deposit (review/spec only)** — Opus 5 owner-resolution ADAPT folded; exact-head rereview active; runtime blocked | openspec/changes/retire-mcp-provider-secret-deposit/; docs/audits/2026-07-24-retire-mcp-provider-secret-deposit-opus5-review.md | #1691 post-#1727 reference-only launch; `bind-host-principal-to-account`; #1736 account-token/client seam; B2/reset/setup owners | claimed:codex-gpt56-secret-custody ACTIVE 2026-07-25 |
