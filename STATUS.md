...
| **Split connector-manifest product contracts** — remote OAuth seven, local stdio seven-name (actorless `converse` unavailable), directory remote-five; proofs never substitute | openspec/changes/reconcile-external-connector-manifests/, STATUS.md, .agents/worktrees.md | origin/main 1272a3d4; legacy retirement waits for local authority/migration proof | claimed:codex-gpt5-desktop-2 ACTIVE 2026-07-22 |
