...
| Paid-market transport + live-price OpenSpec — keep Wave 2 narrow; specify per-class executable totals, reference ceilings, native competition, fees, and freshness | openspec/changes/paid-market-track-e-wave-2-transport/; openspec/changes/paid-market-live-price-discovery/; openspec/changes/build-forward-platform-capabilities/{proposal.md,tasks.md,specs/paid-market-price-index-and-forwards/spec.md} | #1440; PR #1574; R2-1 before execution | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
