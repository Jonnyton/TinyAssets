...
| **Backfill shipped hyperparameter-importance evaluator (PR #1633)** — canonical evaluation owner; future science-domain pre-spec remains a distinct target | openspec/changes/backfill-hyperparameter-importance-shipped-contracts/; openspec/specs/evaluation-runtime-and-scenarios/spec.md; docs/audits/2026-07-22-openspec-full-coverage-audit.md; docs/audits/2026-07-22-legacy-spec-disposition.md | - | claimed:codex-gpt56-spec-2 ACTIVE 2026-07-22 |
| **Promote future hyperparameter science node/fixtures** — target-only sweep schema, methods, warnings, and artifacts; do not conflate with the shipped evaluator | openspec/changes/hyperparameter-importance-science-domain/ | shipped backfill; science-domain owner/design review | pending |
