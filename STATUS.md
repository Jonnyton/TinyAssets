...
| **Correct first-contact OpenSpec truth** — birth is built; provider speech is not authorized until complete requester/BYOC or accepted-market authority exists; never maintainer quota | openspec/changes/universe-creation/, openspec/changes/correct-first-contact-authority-truth/, openspec/changes/archive/2026-07-22-correct-first-contact-authority-truth/, openspec/specs/identity-auth-and-access-control/spec.md, openspec/specs/universe-lifecycle-and-soul/spec.md | #1582; Codex audit complete; runtime waits R2-1a/R2-1b + market authority + Friday security review | claimed:codex-gpt5-desktop ACTIVE 2026-07-22 |
