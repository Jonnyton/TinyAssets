...
|------|-------|---------|--------|
| **Align fresh-host backup configuration** — expose canonical `BACKUP_DEST` and root rclone setup before installer convergence lands | deploy/DEPLOY.md; deploy/tinyassets-env.template; deploy/tinyassets-backup.service; docs/ops/{day-of-cutover.md,backup-restore-runbook.md}; tests/test_fresh_host_backup_config.py; openspec/changes/align-fresh-host-backup-config/; openspec/specs/uptime-and-alarms/spec.md; STATUS.md; REFLECTION.md | #1658 split prerequisite | claimed:codex-gpt56-sol ACTIVE 2026-07-23 |
