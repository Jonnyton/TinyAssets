...
| **Prove shared in-node enqueue caps** — prod deploy already enables the approved primitive; close stale dark wording and §14 global-queue/per-origin concurrency gaps | openspec/changes/prove-node-enqueue-shared-caps/; tests/test_node_enqueue_concurrency.py; STATUS.md; .agents/worktrees.md | round-3 APPROVE in `docs/audits/2026-06-02-in-node-enqueue-adapt-rereview.md`; no runtime behavior change unless proof exposes a bug | claimed:codex-gpt5-desktop-enqueue ACTIVE 2026-07-23 |
