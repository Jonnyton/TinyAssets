...
| **MCPB staged catalog parity** — make manifest metadata equal the staged middleware’s seven canonical handles and fail bundle builds on drift | packaging/mcpb/manifest.json; packaging/mcpb/build_bundle.py; tests/test_packaging_build.py; openspec/changes/reconcile-external-connector-manifests/tasks.md; REFLECTION.md | #1600; archived `collapse-live-mcp-surface-to-5-handles` | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
