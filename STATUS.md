...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — run 30069635807 proved 403 bucket/grant; root cause is a mechanical rename to nonexistent Space (new name 404, pre-rename private bucket 403). Repair identity, then prove backup | .github/workflows/{deploy-prod,install-host-services}.yml; tests/{test_deploy_prod_workflow,test_host_uptime_installers}.py; openspec/changes/preserve-production-backup-config/; openspec/specs/uptime-and-alarms/spec.md; docs/ops/backup-restore-runbook.md; docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | exact-SHA production backup/restore evidence | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
