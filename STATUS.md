...
| **Fix MCP retirement proof blockers** — Opus 5 found Cloudflare probe, deploy ownership, exact-seven, as-built spec, and stale-runbook defects after #1718 | .agents/worktrees.md (this lane); scripts/{probe_retired_mcp_routes.py,mcp_public_canary.py}; tests/{test_probe_retired_mcp_routes.py,test_mcp_public_canary.py,test_deploy_worker_workflow.py,test_deploy_prod_workflow.py}; .github/workflows/{deploy-worker.yml,deploy-prod.yml}; openspec/{changes/reconcile-external-connector-manifests/specs/live-mcp-connector-surface/spec.md,changes/reconcile-external-connector-manifests/reviews/2026-07-24-mcp-directory-retirement.md,specs/live-mcp-connector-surface/spec.md}; docs/ops/2026-06-25-issue3-write-path-uitest.md; deploy/README.md | PR #1722; merged #1718; Opus 5 final reject | claimed:codex-gpt56-mcp-proof-fix ACTIVE 2026-07-24 |
