...
| **Verify deployed wiki discovery** — #1745 merged; prove live SHA/exact-seven, rendered connector result, and organic use/watch | openspec/changes/archive/2026-07-25-scope-wiki-discovery/tasks.md; output/user_sim_session.md; .agents/worktrees.md | prod deploy; Codex in-app browser unavailable, Opus 5 Claude route assigned | claimed:codex-gpt56-wiki-proof ACTIVE 2026-07-25 |
