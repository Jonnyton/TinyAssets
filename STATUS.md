...
| **Review hyperparameter science target design** — Codex draft + 3 reviews approved; host approve/adapt/reject; Claude review follows approval | docs/audits/2026-07-23-hyperparameter-science-design-review.md | host design decision; Claude opposite-provider review before build/push | host-decision |
