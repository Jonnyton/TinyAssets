...
| **Disposition all 52 legacy specs** — canonical, active, history, or claimed target | docs/audits/2026-07-22-legacy-spec-disposition.md; docs/specs/INDEX.md; openspec/changes/brain-okf-canonical-store/{proposal,design,tasks}.md | #1616, #1619 | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
| **Promote durable domain targets into OpenSpec** — runtime-fiction memory graph and hyperparameter-importance evaluator/fixtures remain promoted but lack active changes | openspec/changes/{runtime-fiction-memory-graph,hyperparameter-importance-evaluator}/ | legacy disposition; brain-okf-canonical-store; science-domain lane | pending |
