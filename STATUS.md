...
| **Backfill 9 independent shipped contracts into canonical OpenSpec** — current behavior only | openspec/changes/backfill-independent-shipped-contracts/; openspec/specs/{community-patch-loop,constraint-evaluation,desktop-host-runtime,development-coordination-runtime,domain-plugin-runtime,external-effect-adapters,provider-routing,shared-goals-and-convergence,wiki-commons}/; docs/audits/{2026-07-22-openspec-full-coverage-audit.md,2026-07-22-legacy-spec-disposition.md}; docs/specs/INDEX.md; scripts/worktree_status.py; tests/{test_desktop.py,test_asp_solver.py,test_domain_registry.py,test_wiki_write_back_effector.py} | #1619, #1620 | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
