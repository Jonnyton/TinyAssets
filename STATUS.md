...
| **Harden canonical absolute guarantees** — money/settlement, attribution, birth, learning, receipts | openspec/changes/harden-canonical-absolute-guarantees/; tinyassets/payments/identifiers.py; tinyassets/bid/node_bid.py; tinyassets/bid/settlements.py; tinyassets/api/universe.py; tinyassets/universe_intelligence.py; tinyassets/wiki/trigger_receipts.py; tests/test_payments_schema.py; tests/test_node_bid.py; tests/test_api_universe.py; tests/test_universe_intelligence.py; tests/test_wiki_trigger_receipts.py | active paid/universe/relay lanes | pending |
| **Enforce private Goal read visibility** — owner-only request identity; fail-closed direct/derived reads and aggregates | openspec/changes/enforce-private-goal-read-visibility/; tinyassets/daemon_server.py; tinyassets/api/market.py; tests/test_private_goal_visibility.py; tests/test_goals_surface.py; tests/test_branch_visibility.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/daemon_server.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/api/market.py | retire/supersede draft #1554; opposite-provider review | pending |
