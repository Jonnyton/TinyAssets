...
| **Own-LLM training loop live UI iterations** — host approved testing before review because no real users are at risk; compose a commons workflow, not a platform feature | output/mcp_test_plan.md, output/user_sim_session.md, output/claude_chat_trace.md | - | claimed:codex-gpt5-desktop-llm-loop ACTIVE 2026-07-22 |
| **Own-LLM loop Friday review** — Claude reviews whatever current tested build exists after Fri 2026-07-24 evening; review is retrospective for this pre-user lane | docs/audits/2026-07-22-build-your-own-llm-loop-claude-review.md | accumulated UI iterations + implications artifact | pending |
...
| **Universe-personification relay survivors** — #1515 retires the reversed change; successor deltas stay active/unbuilt until implementation + tests, then sync/archive | openspec/changes/reconcile-universe-personification-relay/ | universe-visibility, brain-okf-canonical-store, live-mcp-connector-surface | pending |
