...
| **Epoch-2 eligible worker wakeup (6.4)** — safe staged selection/status groundwork; activation and descriptor publication depend on daemon claim/lifecycle integration | tinyassets/{cloud_worker.py,branch_tasks_v2.py,daemon_registry.py,dispatcher.py}; tinyassets/storage/request_admissions.py; tinyassets/api/{universe.py,status.py}; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{cloud_worker.py,branch_tasks_v2.py,daemon_registry.py,dispatcher.py,storage/request_admissions.py,api/universe.py,api/status.py}; tests/{test_cloud_worker.py,test_branch_tasks_v2.py,test_daemon_registry.py,test_dispatcher_queue.py,test_supervisor_liveness.py,test_api_status.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md; STATUS.md | #1707; 5.7/5.8 claim + expired/dead-peer recovery owner; then 6.2 completion/activation | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
