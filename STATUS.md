...
| **Epoch-2 eligible worker wakeup (6.4)** — restart only for current-worker-compatible merged candidates; protect active/expired v2 claims; stay inert until the daemon claim path exists | tinyassets/{cloud_worker.py,branch_tasks_v2.py,daemon_registry.py}; tinyassets/storage/request_admissions.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{cloud_worker.py,branch_tasks_v2.py,daemon_registry.py,storage/request_admissions.py}; tests/{test_cloud_worker.py,test_branch_tasks_v2.py,test_daemon_registry.py,test_supervisor_liveness.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md; STATUS.md | #1707; 5.7/5.8 activation dependency | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
