...
| **Restore OpenSpec truth on main** — correct distributed-execution's branch-only checkmarks and graph merge-reducer law drift; spec-only, no runtime change | openspec/changes/distributed-execution/tasks.md, openspec/changes/reconcile-graph-merge-reducer-single-writer/, openspec/specs/graph-execution-substrate/spec.md | ce91c359; 6b28cf89 / PR #1480 | claimed:codex-gpt5-desktop ACTIVE 2026-07-22 |
