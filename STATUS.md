...
- **[P1 filed:2026-07-02 verified:2026-07-02] MERGE of PR #1437 BLOCKED.** WorkOS config DONE (domain secret + MCP resource indicator). Remaining blockers: branch full-suite debt (167 failed/8452 passed), optional-mode fallback still allows anonymous `write_graph target=universe`, daemon-scoped memory writes fail the WorkOS scope gate before their ACL exemption.
