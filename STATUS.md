...
| **Specify conflict-independent full-platform targets** — moderation, tray install, authoring/autoresearch, real-world handoffs | openspec/changes/complete-independent-full-platform-targets/ | full-coverage audit; compare active forward/market changes read-only | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
