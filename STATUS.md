...
|------|-------|---------|--------|
| **Converge fresh-host uptime installers** — install both watchdogs, backup, prune, and disk-watch with current scripts; always enable timers | deploy/hetzner-bootstrap.sh; deploy/install-host-uptime-services.sh; deploy/tinyassets-env.template; deploy/{tinyassets-watchdog,daemon-watchdog,tinyassets-backup,tinyassets-disk-watch}.service; scripts/__init__.py; tinyassets/__init__.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/__init__.py; .github/workflows/{install-host-services,restart-daemon}.yml; tests/{test_host_uptime_installers,test_disk_watch,test_prune_units}.py; deploy/DEPLOY.md; docs/{ops/day-of-cutover.md,audits/2026-07-23-host-uptime-installer-concurrency-proof.md}; REFLECTION.md; openspec/changes/converge-host-uptime-installers/; openspec/specs/uptime-and-alarms/spec.md | #1652; #1655 convergence audit | claimed:codex-gpt56-sol ACTIVE 2026-07-23 |
| **Monitor converged host uptime installation** — prove exact landed commit on disposable Debian plus real install workflow and watchdog/disk/backup/prune executions | docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; production workflow/systemd evidence | Converge fresh-host uptime installers lands | monitoring |
