...
| **R2-1a provider authority** — planning in draft PR #1691; refreshed through #1696; runtime gated | STATUS.md; .agents/worktrees.md; openspec/changes/constrain-set-engine-provider-authority/ | #1660 accepted verdict + `universe-creation` fold; #1617 disposition; #1606 split; #1484; #1621/#1623; auth overlay; subordinate propagation; #1692–#1694 plus #1696 admission/replay/receipt/queue are non-provider and non-external-execution baselines | claimed:codex-gpt56-desktop ACTIVE 2026-07-24 |
| **R2-1b provider-attempt receipts** — strict-valid result-local reply + learning evidence; preserve `call_provider()->str`; no secret-bearing fields or invented sink | openspec/changes/provider-attempt-receipts/ | R2-1a destination ceiling; fail-closed provider-auth overlay; task 2.3 owns call-local credential-kind/authority evidence; runtime files remain unclaimed | pending |
