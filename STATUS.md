...
| **Source-ground 4 direct-owner shipped backfills (draft-only while dependencies are active)** — credential, live MCP/status identity, universe switch, uptime/release | openspec/changes/backfill-direct-owner-shipped-contracts/ | canonical sync waits for credential overlay, connector/identity/universe deltas, and release lane | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
