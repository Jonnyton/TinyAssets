...
| **R2-1a provider authority** — approved planning at `codex/constrain-engine-providers`; PR creation returns GitHub HTTP 500; runtime gated | openspec/changes/constrain-set-engine-provider-authority/ | #1606 split; #1484; #1623 stack; auth overlay; `provider-authority-propagation` | in-flight |
