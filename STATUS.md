...
| **Backfill shipped hyperparameter-importance evaluator** — canonical evaluation owner; future science-domain pre-spec remains target-only | openspec/changes/hyperparameter-importance-evaluator/; openspec/specs/evaluation-runtime-and-scenarios/spec.md; docs/audits/2026-07-22-openspec-full-coverage-audit.md | - | claimed:codex-gpt56-spec-2 ACTIVE 2026-07-22 |
