...
| **Backfill shipped contracts Wave 1** — constraint evaluation, desktop host, coordination diagnostics, domain plugins; current behavior only | openspec/changes/backfill-shipped-behavior-coverage/; docs/audits/2026-07-22-shipped-behavior-backfill-map.md | #1616 (landed) | host-review draft PR #1618 |
