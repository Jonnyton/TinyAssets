...
- **[P0 filed:2026-07-22 verified:2026-07-22]** Newborn/run paths lack complete BYOC/market authority/context; never use maintainer quota. See #1582.
...
| **Classify/rehome eight forward-vision OpenSpec files** — restore canonical specs to as-built truth | docs/audits/2026-07-22-openspec-requirement-classification.md; openspec/changes/reclassify-forward-vision-specs/; openspec/specs/boundary-layer/; openspec/specs/data-commons/; openspec/specs/demand-side/; openspec/specs/hardware-creation/; openspec/specs/paid-market-price-index-and-forwards/; openspec/specs/paid-market-training/; openspec/specs/pooled-training-ownership/; openspec/specs/token-architecture/ | PR #1611/#1612; read active changes + code, do not claim future behavior as built | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
...
| **R2-1a set_engine/credential ceiling** — code green in draft PR #1606; building offline migration/fence; DO NOT MERGE before reviewed live `/data` migration | tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, tests/test_{s2_engine_assignment,s6_s8_engine_sources,credential_fail_closed,provider_allowlist,per_universe_engine_resolution,migrate_engine_assignments,deploy_prod_workflow,p0_triage_workflow}.py, scripts/migrate_engine_assignments.py, Dockerfile, .github/workflows/{deploy-prod,p0-outage-triage,restart-daemon,install-host-services,codex-auth-keepalive,claude-auth-keepalive}.yml, deploy/{DEPLOY.md,hetzner-bootstrap.sh}, packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{api/universe.py,config.py,credential_vault.py,providers/base.py,providers/router.py}, openspec/changes/constrain-founder-provider-routing/, openspec/changes/universe-creation/{design.md,tasks.md}, STATUS.md, REFLECTION.md, .agents/worktrees.md | canonical spec sync waits on active provider/credential Batch B; request authority/run_graph stays #1582; live quiesced run required; R2-1b waits | in-flight draft PR #1606 DO NOT MERGE ACTIVE 2026-07-22 |
