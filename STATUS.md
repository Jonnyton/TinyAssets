...
| **Specify conflict-independent full-platform targets** — moderation, tray install, authoring/autoresearch, real-world handoffs | openspec/changes/complete-independent-full-platform-targets/ | full-coverage audit; compare active forward/market changes read-only | in-flight draft PR #1627 |
