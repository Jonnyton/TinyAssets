...
| **Credential vault + Claude subscription auth** — generic per-universe vault for vcs/llm_subscription/social; GitHub writes resolve token from vault; Claude auth/keepalive mirrors Codex path; avoid telemetry-owned `workflow/api/status.py` | workflow/credential_vault.py, workflow/providers/base.py, workflow/providers/claude_provider.py, workflow/providers/codex_provider.py, workflow/effectors/github_pr.py, workflow/effectors/github_merge.py, workflow/auto_ship_pr.py, workflow/cloud_worker.py, deploy/*auth*, deploy/compose.yml, deploy/workflow-env.template, tests/test_credential_vault.py, tests/test_*github*effector.py, tests/test_auto_ship_pr.py, tests/test_cloud_worker.py | Loop telemetry owns `workflow/api/status.py`; host priority 2026-06-20 | claimed:codex-gpt5-desktop |
