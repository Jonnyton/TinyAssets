...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — #1678 removed mkdir bypass; exact-merge install run 30071496671 green with scoped key + 5 timers. Add explicit backup exercise, then prove archives/restore/deploy preservation | .github/workflows/{deploy-prod,install-host-services}.yml; tests/{test_deploy_prod_workflow,test_host_uptime_installers}.py; openspec/changes/preserve-production-backup-config/; openspec/specs/uptime-and-alarms/spec.md; docs/ops/backup-restore-runbook.md; docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | exact-SHA production backup/restore evidence | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
