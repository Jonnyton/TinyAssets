...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — #1673 preserves backup config; exact-merge install run 30069044182 failed safely: scoped Spaces-key create HTTP 403; diagnose/repair authority, then prove backup | .github/workflows/{deploy-prod,install-host-services}.yml; tests/{test_deploy_prod_workflow,test_host_uptime_installers}.py; openspec/changes/preserve-production-backup-config/; openspec/specs/uptime-and-alarms/spec.md; docs/ops/backup-restore-runbook.md; docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | exact-SHA production backup/restore evidence | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
...
| **Adapt then build pure market capability descriptors** — adversarial review found underspecified v1 grammar/lane/range/digest contracts; code waits for amended opposite-provider approval | openspec/changes/paid-market-live-price-discovery/{design.md,specs/paid-market-price-index-and-forwards/spec.md,tasks.md}; tinyassets/paid_market/descriptors.py; tests/test_paid_market_descriptors.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/paid_market/descriptors.py | existing source review APPROVE; amended research-derived contract needs Claude review; no SQL, credentials, routing, pricing, or execution | claimed:codex-gpt5-desktop-market-descriptors ACTIVE 2026-07-23 |
