...
| **Operator-priority request-local admission verdict** — replace env authority; compose authenticated ordinary scope + exact ACL + exact grant; bind trusted grants to opaque request subjects; fail closed before persistence | STATUS.md; tinyassets/api/{permissions.py,universe.py}; tinyassets/storage/accounts.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{api/{permissions.py,universe.py},storage/accounts.py}; tests/{test_operator_priority_authority.py,test_dispatcher_queue.py,test_submit_request_wiring.py,test_patch_request_incentives.py,test_universe_soul.py,test_universe_server_ledger.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md | #1689; public v2 writer/rollout remains later | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
| **Operator-priority replay reauthorization** — authenticate and re-check ordinary submit scope + current exact ACL before lookup; ACL loss is non-enumerating; priority-only revoke/expiry preserves committed replay | STATUS.md; tinyassets/api/{permissions.py,universe.py}; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/api/{permissions.py,universe.py}; tests/test_operator_priority_authority.py; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md | request-local verdict `830ee8ac` must merge first; public writer integrates this in task 4.3 | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
| **Canonical public request admission** — one request schema on both connectors; strict key/number validation; RFC 8785 body binding; transactional replay/commit; exact result; replay-safe ledger | STATUS.md; pyproject.toml; packaging/mcpb/pyproject.toml; tinyassets/{universe_server.py,directory_server.py,api/{permissions.py,universe.py},storage/request_admissions.py}; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/{pyproject.toml,requirements.txt,tinyassets/{universe_server.py,directory_server.py,api/{permissions.py,universe.py},storage/request_admissions.py}}; tests/{test_request_admission_surface.py,test_request_admission_store.py,test_universe_server_ledger.py,test_directory_server.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md | approved replay `ce57932c`; epoch-2 workers/rollout remain sections 5-8 | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
| **Epoch-2 queue adapter + pure cross-epoch selection** — v2 lifecycle/claim isolation; deterministic v1/v2 selection; operator tier 100/live | STATUS.md; tinyassets/{branch_tasks_v2.py,dispatcher.py,storage/request_admissions.py}; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{branch_tasks_v2.py,dispatcher.py,storage/request_admissions.py}; tests/{test_branch_tasks_v2.py,test_dispatcher_queue.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md | #1694; worker descriptors/rollout remain sections 6-8; B2 authority still gates execution | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
