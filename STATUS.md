...
| **Public capacity envelope contract** — independently approved planning in draft PR #1695; dated baseline + reusable §14 harness | STATUS.md; .agents/worktrees.md; openspec/changes/establish-public-capacity-envelope/ | #1670 adapter consumer; broad `tests/` claim release; domain-owned complete-system scenarios; fresh Claude review before implementation | claimed:codex-gpt56-capacity ACTIVE 2026-07-24 |
