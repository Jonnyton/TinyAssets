...
| **Retire `/mcp-directory*` to ordinary 404; keep `/mcp` canonical** — planning reconciliation only; runtime gets a fresh collision-checked claim | openspec/changes/reconcile-external-connector-manifests/; openspec/changes/operator-request-trigger-contract/; openspec/changes/retire-legacy-live-mcp-tools/; STATUS.md | host directive 2026-07-24; opposite-provider review still gates research-derived runtime hardening | claimed:codex-gpt5-desktop ACTIVE 2026-07-24 |
