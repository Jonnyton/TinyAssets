...
|------|-------|---------|--------|
| **Epoch-2 claimed-request materialization (5.7)** — consume only this worker's live canonical claim; never project v2 into v1 JSON | tinyassets/storage/request_admissions.py; tinyassets/branch_tasks_v2.py; tinyassets/work_targets.py; fantasy_daemon/branch_registrations.py; tests/test_branch_tasks_v2.py; tests/test_submit_request_wiring.py; tests/test_unified_execution.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{storage/request_admissions.py,branch_tasks_v2.py,work_targets.py}; openspec/changes/operator-request-trigger-contract/tasks.md; .agents/worktrees.md; REFLECTION.md | operator-request-trigger-contract 5.1-5.6; 5.8 activation stays PLAN-gated | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
