...
| **Resolve remaining target-spec PLAN conflicts** — store Option 1 selected; private data, primitives, privacy guidance remain | PLAN.md | Claude store source recheck; full-coverage audit; host selects remaining positions | host-decision |
