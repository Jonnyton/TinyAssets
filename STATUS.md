...
| **R2-1a reconcile set_engine provider authority** — split #1606 into a fail-closed destination ceiling for every engine source; planning only | openspec/changes/constrain-set-engine-provider-authority/ | #1606 retained split; #1484 canonical+mirror; #1623 provider-spec stack; auth overlay; land `provider-authority-propagation` prerequisite | claimed:codex-gpt5-root ACTIVE 2026-07-24 |
