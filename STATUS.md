...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — exact-SHA install run 30067224569 green; watchdog/disk/prune + both watchdogs green; backup red: host lacks `BACKUP_DEST`/rclone remote | docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | sanctioned off-host destination credentials/config | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
