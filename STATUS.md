...
| **Specify conflict-independent full-platform targets** — moderation, tray install, portability, authoring, real-world handoffs | openspec/changes/complete-independent-full-platform-targets/ | full-coverage audit; compare active forward/market changes read-only | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
| **Specify collaborative control-plane targets** — catalog, live editing, discovery/remix/convergence, presence, export/private boundary | openspec/changes/complete-collaborative-platform-targets/ | PLAN decisions; build-forward-platform-capabilities | pending |
