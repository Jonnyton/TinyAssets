...
| **R2-4a wiki discovery scoping** — salvage current-main filters from stale #1550; default discovery excludes coordination; public `read_page` scope seam follows universe-creation | openspec/changes/scope-wiki-discovery/; openspec/changes/archive/2026-07-24-scope-wiki-discovery/; openspec/specs/wiki-commons/spec.md; tinyassets/api/wiki.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/api/wiki.py; tests/test_{api_wiki,wiki_tools}.py | #1550 source-only; preserve visibility filtering; universe-creation owns universe_server.py | claimed:codex-gpt56-wiki-scope ACTIVE 2026-07-24 |
| **Retire MCP provider-secret deposit (review/spec only)** — Opus 5 + Codex approve exact spec-only artifacts; strict 42/42; runtime unauthorized | openspec/changes/retire-mcp-provider-secret-deposit/; docs/audits/2026-07-24-retire-mcp-provider-secret-deposit-opus5-review.md | #1691 local launch; production B2 authority; #1736 native state; test-reset + successor-setup owners | host-review |
