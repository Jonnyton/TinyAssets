...
| **Promote hyperparameter-importance evaluator into OpenSpec** | openspec/changes/hyperparameter-importance-evaluator/ | canonical `evaluation-runtime-and-scenarios` owner; PR #1627 adjacent read-only | pending |
| **Backfill sandbox availability, status, and fail-loud execution contracts** | openspec/changes/backfill-sandbox-availability-contracts/; openspec/specs/{provider-routing,graph-execution-substrate,live-mcp-connector-surface,distributed-execution}/spec.md; docs/audits/2026-07-22-openspec-full-coverage-audit.md | PR #1629; active distributed-execution + PR #1573 read-only; PR #1626 does not own sandbox status | claimed:codex-gpt56-spec-2 ACTIVE 2026-07-22 |
