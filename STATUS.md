...
| **Retire `/mcp-directory*`** — remove runtime/catalog/discovery/edge routing so only canonical `/mcp` survives; exact ordinary-404 proof | PLAN.md (MCP distribution sections only); REFLECTION.md; openspec/changes/reconcile-external-connector-manifests/; openspec/specs/live-mcp-connector-surface/spec.md (retirement sync only); tinyassets/{universe_server.py,directory_server.py,connector_catalog.py,auth/middleware.py,api/market.py}; deploy/cloudflare-worker/; .github/workflows/deploy-worker.yml; scripts/{mcp_public_canary.py,mcp_tool_canary.py,probe_retired_mcp_routes.py}; packaging/{registry/,claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/}; focused route/parity/admission/canary tests including tests/test_probe_retired_mcp_routes.py; docs/{ops/acceptance-probe-catalog.md,ops/operator-request-v2-inventory.md,ops/mcp-host-proof-registry.md,ops/mcp-directory-*.md,ops/open-webui-no-login-pack.md,ops/librechat-no-login-pack.md,ops/openai-app-submission-*.md,ops/claude-directory-submission-closeout-2026-05-02.md,ops/mcp-cursor-registration-proof-2026-05-01.md,ops/mcp-codex-registration-proof-2026-05-02.md,ops/mcp-codex-runtime-proof-2026-05-02.md,ops/open-webui-runtime-proof-2026-05-01.md,ops/librechat-runtime-proof-2026-05-01.md,design-notes/2026-05-01-mcp-host-customer-matrix.md,exec-plans/active/2026-05-01-host-discoverability-and-onboarding-rollout.md} | PR #1688; host route decision 2026-07-24 + Opus 5 approve; preserve dated proofs; later hardening lanes remain | claimed:codex-gpt56-mcp-retirement ACTIVE 2026-07-24 |
