...
| **Reconcile knowledge/memory OpenSpec coverage (Batch B)** — mini-Brain promotion plus long-horizon memory/learning lifecycle | openspec/changes/reconcile-knowledge-memory-spec-coverage/; openspec/specs/knowledge-retrieval-and-memory/spec.md | read-only full-coverage audit, brain/memory/learning code+tests, brain-okf-canonical-store; do not claim future OKF store | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
