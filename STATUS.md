...
| **Adapt connector manifests for canonical `/mcp` and near-term `/mcp-directory` retirement** — rewrite three-product contract to remote `/mcp` + local MCPB; planning only | openspec/changes/reconcile-external-connector-manifests/ | host directive 2026-07-24; security/host migration audits; no runtime changes in this slice | claimed:codex-gpt5-root ACTIVE 2026-07-24 |
