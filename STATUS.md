...
|------|-------|---------|--------|
| **Reconcile provider/credential OpenSpec coverage (Batch B)** — provider contracts, secret stripping, refresh viability, cooldown/status evidence | openspec/changes/reconcile-provider-and-credential-spec-coverage/; openspec/specs/provider-routing/spec.md; openspec/specs/credential-vault/spec.md | read-only docs/audits/2026-07-22-openspec-full-coverage-audit.md, provider/vault/status code and tests; recheck pending R2-1a before sync | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
