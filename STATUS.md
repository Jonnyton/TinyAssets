...
| **R2-1a provider authority** — planning in draft PR #1691; refreshed after #1692; runtime gated | STATUS.md; .agents/worktrees.md; openspec/changes/constrain-set-engine-provider-authority/ | #1660 accepted verdict + `universe-creation` fold; #1617 disposition; #1606 split; #1484; #1621/#1623; auth overlay; subordinate propagation; #1692 admission is non-provider baseline | claimed:codex-gpt56-desktop ACTIVE 2026-07-24 |
