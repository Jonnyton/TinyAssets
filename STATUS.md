...
| **Epoch-2 eligible worker wakeup (6.4)** — restart only for current-worker-compatible merged candidates; protect active v2 claims | tinyassets/cloud_worker.py; tinyassets/branch_tasks_v2.py; tinyassets/storage/request_admissions.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{cloud_worker.py,branch_tasks_v2.py,storage/request_admissions.py}; tests/{test_cloud_worker.py,test_branch_tasks_v2.py}; openspec/changes/operator-request-trigger-contract/tasks.md; REFLECTION.md; STATUS.md | #1707 | claimed:codex-gpt5-desktop-operator ACTIVE 2026-07-24 |
