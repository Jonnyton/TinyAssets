...
| **Backfill 4 runtime/memory shipped contracts into canonical OpenSpec** — daemon identity, daemon runtime, graph execution, read-only OKF export | openspec/changes/backfill-runtime-memory-shipped-contracts/; openspec/specs/{daemon-identity-and-host-pool,daemon-runtime-and-dispatch,graph-execution-substrate,knowledge-retrieval-and-memory}/; docs/audits/{2026-07-22-openspec-full-coverage-audit.md,2026-07-22-legacy-spec-disposition.md}; docs/specs/INDEX.md; tests/test_dispatcher_queue.py | #1622; read-coordinate `distributed-execution`, `brain-okf-canonical-store` | claimed:codex-gpt56-desktop ACTIVE 2026-07-22 |
