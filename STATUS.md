...
|------|-------|---------|--------|
| **Exercise converged host uptime jobs** — install + four jobs green; backup red because deploy deletes canonical `BACKUP_DEST`; preserve config, restore Spaces, prove backup | .github/workflows/{deploy-prod,install-host-services}.yml; tests/{test_deploy_prod_workflow,test_host_uptime_installers}.py; openspec/changes/preserve-production-backup-config/; openspec/specs/uptime-and-alarms/spec.md; docs/ops/backup-restore-runbook.md; docs/audits/2026-07-23-host-uptime-installer-concurrency-proof.md; STATUS.md; production workflow/systemd evidence | exact-SHA production backup/restore evidence | claimed:codex-gpt5-desktop ACTIVE 2026-07-23 |
...
| **Repair and prove shared in-node enqueue caps** — draft PR #1672; OpenSpec archived; reviews APPROVE; no post-fix live-use evidence until deploy/observation | openspec/changes/archive/2026-07-24-prove-node-enqueue-shared-caps/; openspec/specs/{graph-execution-substrate,daemon-runtime-and-dispatch}/spec.md; tinyassets/{runs.py,branch_tasks.py,graph_compiler.py}; fantasy_daemon/__main__.py; packaging/claude-plugin/plugins/tinyassets-universe-server/runtime/tinyassets/{runs.py,branch_tasks.py,graph_compiler.py}; tests/test_node_enqueue_{concurrency,verb}.py; tests/test_{dispatcher_queue,bug_investigation_dispatcher}.py; STATUS.md; .agents/worktrees.md; REFLECTION.md | concurrency/storage APPROVE; security/spec APPROVE; epoch-2 transactional equivalents remain an explicit foldback gate | claimed:codex-gpt5-desktop-enqueue ACTIVE 2026-07-23 |
