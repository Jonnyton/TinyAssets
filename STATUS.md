...
| **R2-1a reconcile set_engine provider authority** — fold #1606's founder-key boundary into fail-closed eligibility for every engine source; planning only | openspec/changes/constrain-set-engine-provider-authority/ | explicit #1606 disposition; #1484 releases `tinyassets/api/universe.py`; #1623 releases canonical provider-routing spec; review provider-auth overlay | claimed:codex-gpt5-root ACTIVE 2026-07-24 |
