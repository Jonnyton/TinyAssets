...
| **Keep disk-pressure remediation running** — preserve alert exit 1 while ensuring transcript rotation and auto-prune still execute in order | openspec/changes/keep-disk-pressure-remediation-running/; openspec/specs/uptime-and-alarms/spec.md; deploy/tinyassets-disk-watch.service; tests/test_disk_watch.py; STATUS.md; .agents/worktrees.md | canonical disk-pressure stop-seam requirement; claim-check tests overlap is stale-primary false positive (absent on origin/main) | claimed:codex-gpt5-desktop-disk ACTIVE 2026-07-23 |
