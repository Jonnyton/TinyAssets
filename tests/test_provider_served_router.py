...
""",
    ...
    # Engine MCP off (this config) -> mcp_servers is cleared so the served turn is
    # WebFetch-only. (When engine MCP is on + a route exists, _codex_engine_mcp_args
    # wires the one trusted tinyassets server instead — see test_engine_mcp_server.)
