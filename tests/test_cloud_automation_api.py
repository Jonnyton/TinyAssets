...
# The two `_pump_cloud_automation_triggers` cases that lived here were deleted
# on 2026-08-29 with the host-run `tinyassets.cloud_worker` fleet: nothing runs
# outside a user's universe (PLAN.md). Their subject was the fleet's OWN
# production entry point, not the API surface this module covers. The served
# equivalents are in tests/test_assigned_queue_consumer_live_worker.py --
# `test_consumer_activates_then_claims_and_executes_without_env_identity`
