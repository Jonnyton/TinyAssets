...
from tinyassets.credential_broker import set_github_connection_metadata
...
def test_set_preference_resolves_founder_handle_from_vault(
    owner_env, platform_vault_env
):
    ...
    set_github_connection_metadata("u1", _DEST, account_login="TheFounder")
    out = _call(
        "review_queue_set_preference", universe_id="u1", branch_def_id="bd",
