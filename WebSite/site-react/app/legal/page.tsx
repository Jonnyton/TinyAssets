    ...
    <div className={styles.page}>
      <section className="legal">
        <div className="wrap">
          ...
          <p id="app-data">
            <strong>What the apps collect (web, Android, desktop).</strong> All three apps are the same client of the hosted service and handle data the same way. We collect: (1) a <strong>sign-in identity</strong> — your email and a user id, via WorkOS AuthKit — used only to authenticate you and bind your universe to your account; (2) the <strong>AI provider credential</strong> you choose to deposit (a subscription token or API key) — sent straight to a secure per-universe vault over TLS, <strong>never through the chat/LLM</strong>, used only so your universe can run on the compute you gave it, never sold, never used for ads, never training data; (3) the <strong>messages and files you send your universe</strong> — used to provide the service. All data is encrypted in transit. We do not sell your data, show ads, or use third-party ad trackers. You can request deletion of your account and its data at any time via{" "}
