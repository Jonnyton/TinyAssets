          ...
          {reading && !feed ? (
            ...
            <div className="state state--error">
              ...
              <div>
                ...
                <p className="state__sub">This reading comes live from the same surface you'd use — try Refresh MCP, or read the trail straight from <a href="https://github.com/Jonnyton/TinyAssets/pulls" target="_blank" rel="noreferrer">GitHub pull requests ↗</a>.</p>
              </div>
            </div>
          ) : feed && isAwake ? (
      ...
      <section className="ch ch--close" aria-labelledby="close-title">
        <div className="container ch__inner">
          ...
          <div className="close__row">
            ...
            <a className="close__cta close__cta--alt" href="https://github.com/Jonnyton/TinyAssets/pulls" target="_blank" rel="noreferrer">
