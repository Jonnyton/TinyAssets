...
export const metadata: Metadata = {
  ...
  description:
    "The instrument panel: Tiny's live pulse, plain-words explanations of how each reading is measured, the engine's own release receipt, the public uptime checks, and the honest fine print.",
