<!--
  /patterns — retired route, now /start. Soft-landing alias.
  The link is the primary affordance; the 2s meta refresh is a convenience.
-->
<svelte:head>
  <title>Start — Tiny</title>
  <link rel="canonical" href="https://tinyassets.io/start" />
  <meta http-equiv="refresh" content="2;url=/start" />
  <meta name="description" content="The patterns page is now Start — connect your chatbot with one URL and bring a first prompt that works today." />
</svelte:head>

<section class="moved">
  <p class="eyebrow">this page moved</p>
  <p class="moved__line">
    The patterns page is now <em>Start</em> — connect your chatbot with one
    URL, then bring a first prompt for whichever kind of work you do.
  </p>
  <a class="moved__cta" href="/start">Go to Start →</a>
  <p class="moved__sub ev">/patterns → /start · taking you there in a moment</p>
</section>
