<!--
  /catalog — retired route, now /goals. Soft-landing alias.
  The link is the primary affordance; the 2s meta refresh is a convenience.
-->
<svelte:head>
  <title>Goals — Tiny</title>
  <link rel="canonical" href="https://tinyassets.io/goals" />
  <meta http-equiv="refresh" content="2;url=/goals" />
  <meta name="description" content="The catalog is now the Goals board — the live public list of what Tiny is working toward, each with its outcome ladder." />
</svelte:head>

<section class="moved">
  <p class="eyebrow">this page moved</p>
  <p class="moved__line">
    The catalog is now the <em>Goals board</em> — the live public list of what
    Tiny is working toward, each with its outcome ladder.
  </p>
  <a class="moved__cta" href="/goals">See the Goals board →</a>
  <p class="moved__sub ev">/catalog → /goals · taking you there in a moment</p>
</section>
