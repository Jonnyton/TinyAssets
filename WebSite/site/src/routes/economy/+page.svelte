<!--
  /economy — retired route, now /fine-print. Soft-landing alias.
...
<svelte:head>
  ...
  <meta name="description" content="The honest economy note — a test rail today, real later — now lives in the Fine print, Tiny's ops room." />
</svelte:head>

<section class="moved">
  <p class="eyebrow">this page moved</p>
  <p class="moved__line">
    The economy note now lives in the <em>Fine print</em> — kept honest: a
    test rail today, with the real version written as intent, not promise.
  </p>
  <a class="moved__cta" href="/fine-print">Open the Fine print →</a>
  <p class="moved__sub ev">/economy → /fine-print · taking you there in a moment</p>
</section>
