...
- 2026-07-22 CREATE wf-pr1506-verdict-landedness branch=claude/pr1506-verdict-landedness base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-uitest-proof-durability branch=claude/uitest-proof-durability base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-status-concerns-audit branch=claude/status-concerns-audit base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-stale-alarm-issues branch=claude/stale-alarm-issues base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-pr1506-landedness-fixups branch=claude/pr1506-landedness-fixups base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-retired-agents branch=claude/fix-retired-agents base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-specs-index branch=claude/fix-specs-index base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-plan-citations branch=claude/fix-plan-citations base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-codex-mirror-claim branch=claude/fix-codex-mirror-claim base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-ideas-pipeline branch=claude/fix-ideas-pipeline base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-audit-lane-conversion branch=claude/audit-lane-conversion base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-env-catalog branch=claude/fix-env-catalog base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-triage-exec-plans branch=claude/triage-exec-plans base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-refresh-conventions-counts branch=claude/refresh-conventions-counts base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-probe-catalog-probe003-truth branch=claude/probe-catalog-probe003-truth base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-persona-note-relay-reshape branch=claude/persona-note-relay-reshape base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-worktree-lane-sweep-audit branch=docs/worktree-lane-sweep-audit base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-codex-lane-publication branch=claude/fix-codex-lane-publication base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-recover-auto-enroll-behind-fix branch=recover/auto-enroll-behind-branch-fix base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-carry-auth-surface-sweep branch=claude/carry-auth-surface-sweep base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-codex-publish-proof branch=claude/codex-publish-proof base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-fix-codex-verdict-attribution branch=claude/fix-codex-verdict-attribution base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-publish-proof-green branch=claude/publish-proof-green base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-codex-clone-visibility branch=claude/codex-clone-visibility base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-legacy-mcp-server-fence branch=claude/legacy-mcp-server-fence base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-venv-entrypoint-extract branch=claude/venv-entrypoint-extract base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-worktree-anchor-branch-audit branch=claude/worktree-anchor-branch-audit base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-write-page-commons-residual branch=claude/write-page-commons-residual base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-status-write-contention branch=claude/status-write-contention base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-status-q63-privacy-row-audit branch=claude/status-q63-privacy-row-audit base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-restore-0bc841aa-collateral branch=claude/restore-0bc841aa-collateral base=origin/main provider=claude-code
- 2026-07-22 REMOVE wf-restore-0bc841aa-collateral branch=claude/restore-0bc841aa-collateral merged=False forced=True
- 2026-07-22 CREATE wf-context-budget-gate branch=claude/context-budget-gate base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-probe-catalog-exit6-scope branch=claude/probe-catalog-exit6-scope-truth base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-auth-audit-owner-map branch=claude/auth-audit-owner-map base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-stale-nondraft-pr-triage branch=claude/stale-nondraft-pr-triage base=origin/main provider=claude-code
- 2026-07-22 CREATE wf-personification-section-6-defs branch=claude/personification-section-6-defs base=origin/main provider=claude-code
- 2026-07-23 CREATE wf-provider-attempt-receipts branch=codex/provider-attempt-receipts base=origin/main provider=codex-provider-receipts
- 2026-07-29 CREATE wf-universe-visibility-closeout-20260728 branch=codex/universe-visibility-closeout-20260728 base=origin/main provider=codex-openspec-drain-2
- 2026-07-29 CREATE wf-drain-candidate-recovery branch=codex/drain-candidate-recovery base=origin/main provider=codex-drain-candidate-recovery
- 2026-07-29 CREATE wf-drain-20260729-145600-e75271 branch=drain/20260729-145600-e75271/admission base=origin/main provider=drain-20260729-145600-e75271
- 2026-07-30 CREATE wf-drain-20260729-194051-a81d12-status-blocker-refresh branch=chore/drain-20260729-194051-a81d12-status-blocker-refresh base=origin/main provider=drain-20260729-194051-a81d12
- 2026-07-30 CREATE wf-drain-20260730-access-cookie-audit branch=chore/drain-20260730-access-cookie-audit base=origin/main provider=drain-20260730-095018-67aecc
- 2026-07-31 REMOVE wf-drain-20260730-182443-ef55a1 branch=chore/drain-20260730-182443-ef55a1 merged=True forced=False
- 2026-07-31 CREATE wf-universe-custom-agents branch=codex/universe-custom-agents base=origin/main provider=codex-gpt5-desktop
- 2026-08-01 CREATE wf-drain-backlog-refinery branch=fix/drain-backlog-refinery base=origin/main provider=codex-gpt5-desktop
- 2026-08-01 CREATE wf-refine-paid-market-live-price-status-20260801-113628 branch=chore/refine-paid-market-live-price-status-20260801-113628 base=origin/main provider=drain-20260801-113628-6deab6
- 2026-08-01 CREATE wf-refine-operator-request-trigger-bounded-20260801-113628 branch=chore/refine-operator-request-trigger-bounded-20260801-113628 base=origin/main provider=drain-20260801-113628-6deab6
- 2026-08-01 REMOVE wf-refine-operator-request-trigger-bounded-20260801-113628 branch=chore/refine-operator-request-trigger-bounded-20260801-113628 merged=True forced=False
- 2026-08-01 CREATE wf-agent-runtime-grant-foldback branch=chore/agent-runtime-grant-foldback-20260801 base=origin/main provider=codex-gpt5-runtime-authority-foldback
- 2026-08-02 CREATE wf-refine-data-commons-status-20260801-171005 branch=chore/refine-data-commons-status-20260801-171005 base=origin/main provider=drain-20260801-171005-f06196
- 2026-08-02 CREATE wf-debloat-coordination branch=claude/debloat-coordination base=origin/main provider=claude-code
- 2026-08-02 CREATE wf-refine-reconcile-preflight-stray-writers-20260802 branch=drain/20260802-132145-5c093f/refine-reconcile-preflight-stray-writers base=origin/main provider=drain-20260802-132145-5c093f
- 2026-08-02 CREATE wf-drain-20260802-132145-5c093f-refine-gh-cli-pin-a011 branch=drain/20260802-132145-5c093f/refine-gh-cli-pin-a011 base=origin/main provider=drain-20260802-132145-5c093f
- 2026-08-03 CREATE wf-refine-chatgpt-oauth-continuity-20260803-8c2a9c branch=chore/refine-chatgpt-oauth-continuity-8c2a9c base=origin/main provider=drain-20260803-103601-8c2a9c
- 2026-08-03 CREATE wf-drain-20260803-103601-8c2a9c-refine-chatgpt-oauth-status branch=chore/drain-20260803-refine-chatgpt-oauth-status base=origin/main provider=drain-20260803-103601-8c2a9c
- 2026-08-03 CREATE wf-refine-chatgpt-oauth-continuity-drain branch=chore/refine-chatgpt-oauth-continuity-drain base=origin/main provider=drain-20260803-104918-679356
- 2026-08-03 CREATE wf-drain-20260803-104918-679356-refine-chatgpt-oauth branch=chore/drain-20260803-104918-679356-refine-chatgpt-oauth base=origin/main provider=drain-20260803-104918-679356
- 2026-08-04 CREATE wf-ledger-stale-trim branch=claude/ledger-stale-trim base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-tripwire-cadence branch=claude/tripwire-cadence base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-quarantine-branch-eval branch=claude/quarantine-branch-eval base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-quarantine-wave2 branch=claude/quarantine-wave2 base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-goals-ledger-actor branch=claude/goals-ledger-actor base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-quarantine-patchnodes-shape branch=claude/quarantine-patchnodes-shape base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-tray-headless-and-events branch=claude/tray-headless-and-events base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-pr-sync-behind branch=claude/pr-sync-behind base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-merge-attribution-decision branch=claude/merge-attribution-decision base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-adr004-exact-diff branch=claude/adr004-exact-diff base=origin/main provider=claude-code
- 2026-08-04 REMOVE wf-quarantine-patchnodes-shape branch=claude/quarantine-patchnodes-shape merged=True forced=False
- 2026-08-04 REMOVE wf-pr-sync-behind branch=claude/pr-sync-behind merged=True forced=False
- 2026-08-04 REMOVE wf-merge-attribution-decision branch=claude/merge-attribution-decision merged=True forced=False
- 2026-08-04 REMOVE wf-quarantine-wave2 branch=claude/quarantine-wave2 merged=False forced=True
- 2026-08-04 REMOVE wf-tray-headless-and-events branch=claude/tray-headless-and-events merged=True forced=True
- 2026-08-04 CREATE wf-wire-merge-attribution branch=claude/wire-merge-attribution base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-quarantine-wave4 branch=claude/quarantine-wave4 base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-cloud-drain-universe-id-prefix branch=claude/cloud-drain-universe-id-prefix base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-cloud-drain-branch-id-shape branch=claude/cloud-drain-branch-id-shape base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-openspec-precondition-guard branch=claude/openspec-precondition-guard base=origin/main provider=claude-code
- 2026-08-04 CREATE wf-cloud-drain-handoff-rev2 branch=claude/cloud-drain-handoff-rev2 base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-quarantine-wave5 branch=claude/quarantine-wave5 base=claude/quarantine-wave4 provider=claude-code
- 2026-08-05 CREATE wf-mvp-e2e-walk-evidence branch=claude/mvp-e2e-walk-evidence base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-fix-cloud-automation-time-bomb branch=claude/fix-cloud-automation-time-bomb base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-main-red-regressions branch=claude/main-red-regressions base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-fix-cloud-automation-fuse-followup branch=claude/fix-cloud-automation-fuse-followup base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-quarantine-wave5b branch=claude/quarantine-wave5b base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-automation-run-once branch=claude/automation-run-once base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-user-assigned-llm-policy branch=claude/user-assigned-llm-policy base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-attribution-no-credit-refusal branch=claude/attribution-no-credit-refusal base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-cloud-worker-first-slice-bootstrap branch=claude/cloud-worker-first-slice-bootstrap base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-rename-straggler-sweep branch=claude/rename-straggler-sweep base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-auth-fixture-batch branch=claude/auth-fixture-batch base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-ledger-band-4 branch=claude/ledger-band-4 base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-fix-next-action-label branch=claude/fix-next-action-label base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-spec-owner-operable-automation branch=claude/spec-owner-operable-automation base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-ledger-tail branch=claude/ledger-tail base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-quarantine-oracle branch=claude/quarantine-oracle base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-slack-transport branch=claude/slack-transport base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-diagnose-activation-convergence branch=claude/diagnose-activation-convergence base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-select-among-own-provider-bindings branch=claude/select-among-own-provider-bindings base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-ledger-to-zero branch=claude/ledger-to-zero base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-admit-slack-app-events branch=claude/admit-slack-app-events base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-github-capability-case-insensitive branch=claude/github-capability-case-insensitive base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-health-surfaces-queue-blocker branch=claude/health-surfaces-queue-blocker base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-surface-quarantine-reason branch=claude/surface-quarantine-reason base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-fleet-universe-binding branch=claude/fleet-universe-binding base=origin/main provider=claude-code
- 2026-08-05 CREATE wf-serve-universe-with-work branch=claude/serve-universe-with-work base=origin/main provider=claude-code
- 2026-08-06 CREATE wf-capacity-gate-observability branch=claude/capacity-gate-observability base=origin/main provider=claude-code
- 2026-08-06 CREATE wf-active-execution-context branch=claude/active-execution-context base=origin/main provider=claude-code
- 2026-08-07 CREATE wf-founder-canon-not-public branch=claude/founder-canon-not-public base=origin/main provider=claude-code
- 2026-08-07 CREATE wf-unblock-soul-loop-dispatch-test branch=claude/unblock-soul-loop-dispatch-test base=origin/main provider=claude-code
